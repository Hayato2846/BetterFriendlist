...
### Improved
- **Appearance Onboarding** - Reworked the dialog around Blizzard's native portrait frame, inset, controls, and button bar; the unclipped style cards mirror Modern's right-side navigation and Legacy's top/bottom tabs, Simple Mode and Compact Mode are part of setup, every supported theme receives its own skin, and the compact theme grid remains scrollbar-free.
