...
### Fixed
- **Classic Login Taint** - Stopped a login-time protected action warning caused by silently opening Blizzard's Friends frame on Classic Era and Season of Discovery clients.
