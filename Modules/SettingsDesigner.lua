...
local function RegisterBrokerPages()
	...
	AddDropdown("broker.friends", { key = "brokerClickAction", group = "integration", label = T("BROKER_SETTINGS_CLICK_ACTION", "Click Action"), list = { toggle = T("BROKER_CLICK_TOGGLE", "Toggle Friends"), friends = T("BROKER_CLICK_FRIENDS", "Open Friends"), settings = T("BROKER_CLICK_SETTINGS", "Open Settings") }, orderList = { "toggle", "friends", "settings" }, default = "toggle", order = 160, parentCheck = function() return GetDB("brokerEnabled", false) end })
