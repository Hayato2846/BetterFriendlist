...
local function RegisterFriendsPages()
	...
	AddToggle("friends.behavior", { key = "simpleModeShowSearch", group = "list", label = T("SETTINGS_SIMPLE_MODE_SHOW_SEARCH", "Show Search in Simple Mode"), desc = T("SETTINGS_SIMPLE_MODE_SHOW_SEARCH_DESC", "Keep the search field visible while Simple Mode is enabled."), default = true, order = 130, parentCheck = function() return GetDB("simpleMode", false) end, method = "OnSimpleModeShowSearchChanged" })
