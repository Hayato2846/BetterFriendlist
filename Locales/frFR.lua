...
if GetLocale() == "frFR" then
	...
	L.DIALOG_UI_PANEL_RELOAD_TEXT = "La modification du paramètre de hiérarchie de l'IU nécessite un rechargement de l'interface.\n\nRecharger maintenant ?"
	L.DIALOG_UI_PANEL_RELOAD_BTN1 = "Recharger"
	L.DIALOG_UI_PANEL_RELOAD_BTN2 = "Annuler"
	L.RAID_HELP_TITLE = "Aide sur les raids"
	L.RAID_HELP_TEXT = "Cliquez pour obtenir de l'aide sur la liste de raid."
	L.RAID_HELP_MULTISELECT_TITLE = "Sélection multiple"
	L.RAID_HELP_MULTISELECT_TEXT = "Maintenez Ctrl et cliquez gauche pour sélectionner plusieurs joueurs.\nUne fois sélectionnés, glissez-déposez-les dans n'importe quel groupe pour les déplacer tous en même temps."
	L.RAID_HELP_MAINTANK_TITLE = "Tank principal"
	L.RAID_HELP_MAINTANK_TEXT = "Maj + Clic droit sur un joueur pour le définir comme tank principal.\nUne icône de tank apparaîtra à côté de son nom."
	L.RAID_HELP_MAINASSIST_TITLE = "Assistant principal"
	L.RAID_HELP_MAINASSIST_TEXT = "Ctrl + Clic droit sur un joueur pour le définir comme assistant principal.\nUne icône d'assistant apparaîtra à côté de son nom."
	L.RAID_HELP_DRAGDROP_TITLE = "Glisser-déposer"
	L.RAID_HELP_DRAGDROP_TEXT = "Glissez n'importe quel joueur pour le déplacer entre les groupes.\nVous pouvez également glisser plusieurs joueurs sélectionnés en même temps.\nLes emplacements vides peuvent être utilisés pour échanger des positions."
	L.RAID_HELP_COMBAT_TITLE = "Verrouillage en combat"
	L.RAID_HELP_COMBAT_TEXT = "Les joueurs ne peuvent pas être déplacés pendant le combat.\nCeci est une restriction Blizzard pour éviter les erreurs."	L.RAID_INFO_UNAVAILABLE = "Aucune info disponible"
	...
	L.RAID_ERROR_NO_SAVED_INSTANCES = "Vous n'avez aucune instance de raid sauvegardée."
	L.RAID_ERROR_LOAD_RAID_INFO = "Erreur : Impossible de charger la fenêtre d'info de raid."
	...
	L.RAID_ERROR_MOVE_FAILED = "Déplacement échoué : %s"	L.DIALOG_MIGRATE_TEXT = "Migrer les groupes d'amis de FriendGroups vers BetterFriendlist ?\n\nCela va :\n• Créer tous les groupes à partir des notes BNet\n• Assigner les amis à leurs groupes\n• Optionnellement nettoyer les notes\n\n|cffff0000Attention : Cela ne peut pas être annulé !|r"
	...
	L.SETTINGS_HEADER_COUNT_FORMAT = "Compteurs d'En-tête de Groupe"
	L.SETTINGS_HEADER_COUNT_FORMAT_DESC = "Choisissez comment les compteurs d'amis sont affichés dans les en-têtes de groupe"
	L.SETTINGS_HEADER_COUNT_VISIBLE = "Filtré / Total (Défaut)"
	L.SETTINGS_HEADER_COUNT_ONLINE = "En ligne / Total"
	L.SETTINGS_HEADER_COUNT_BOTH = "Filtré (En ligne) / Total"
	...
	L.FEATURE_NOT_AVAILABLE_CLASSIC = "Cette fonctionnalité n'est pas disponible en Classic"	L.SETTINGS_CLOSE_ON_GUILD_TAB = "Fermer BetterFriendlist lors de l'ouverture de Guilde"
	L.SETTINGS_CLOSE_ON_GUILD_TAB_DESC = "Fermer automatiquement BetterFriendlist lorsque vous cliquez sur l'onglet Guilde"
	L.SETTINGS_HIDE_GUILD_TAB = "Masquer l'onglet Guilde"
	L.SETTINGS_HIDE_GUILD_TAB_DESC = "Masquer l'onglet Guilde de la liste d'amis"
	L.SETTINGS_USE_UI_PANEL_SYSTEM = "Respecter la hiérarchie de l'IU"
	L.SETTINGS_USE_UI_PANEL_SYSTEM_DESC = "Empêche BetterFriendlist de s'ouvrir par-dessus d'autres fenêtres d'IU (Personnage, Grimoire, etc.). Nécessite /reload."	
	...
	-- GUILD UI WARNING
	-- ========================================
	L.CLASSIC_GUILD_UI_WARNING_TITLE = "IU de guilde classique désactivée"
	L.CLASSIC_GUILD_UI_WARNING_TEXT = "BetterFriendlist a désactivé l'IU de guilde classique car seule l'IU de guilde moderne de Blizzard est compatible avec BetterFriendlist.\n\nL'onglet Guilde ouvre désormais l'IU de guilde moderne de Blizzard."
