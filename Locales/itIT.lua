...
if GetLocale() == "itIT" then
	...
	L.SETTINGS_HEADER_COUNT_FORMAT = "Conteggi Intestazione Gruppo"
	L.SETTINGS_HEADER_COUNT_FORMAT_DESC = "Scegli come vengono visualizzati i conteggi degli amici nelle intestazioni dei gruppi"
	L.SETTINGS_HEADER_COUNT_VISIBLE = "Filtrati / Totale (Predefinito)"
