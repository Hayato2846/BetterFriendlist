...
L.RAID_HELP_MAINTANK_TEXT = "Shift + Правый клик на игрока, чтобы назначить его главным танком.\nРядом с его именем появится значок танка."
L.RAID_HELP_MAINASSIST_TITLE = "Главный помощник"
L.RAID_HELP_MAINASSIST_TEXT = "Ctrl + Правый клик на игрока, чтобы назначить его главным помощником.\nРядом с его именем появится значок помощника."
