...
BFL:RegisterLocale("ruRU", function()
	local L = BFL_LOCALE
	L.SETTINGS_TAB_FILTER_SORT = "Быстрый фильтр и сортировка"
	L.FILTER_BUILDER_DESC = "Выберите пункты меню, измените их порядок и создайте собственные фильтры или цепочки сортировки."
	L.FILTER_BUILDER_FILTERS = "Быстрые фильтры"
	L.FILTER_BUILDER_SORTERS = "Сортировки"
	L.FILTER_BUILDER_ADD_FILTER = "Новый фильтр"
	L.FILTER_BUILDER_ADD_SORTER = "Новая сортировка"
	L.FILTER_BUILDER_UP = "Вверх"
	L.FILTER_BUILDER_DOWN = "Вниз"
	L.FILTER_BUILDER_DUPLICATE = "Копировать"
	L.FILTER_BUILDER_DELETE = "Удалить"
	L.FILTER_BUILDER_RESET = "Сбросить"
	L.FILTER_BUILDER_EDITOR = "Редактор"
	L.FILTER_BUILDER_NAME = "Название"
	L.FILTER_BUILDER_ICON = "Значок"
	L.FILTER_BUILDER_GROUP = "Группа"
	L.FILTER_BUILDER_ADD_CONDITION = "Добавить условие"
	L.FILTER_BUILDER_ADD_GROUP = "Добавить группу"
	L.FILTER_BUILDER_ADD_SORT_STEP = "Добавить этап сортировки"
	L.FILTER_BUILDER_NEW_FILTER = "Пользовательский фильтр"
	L.FILTER_BUILDER_NEW_SORTER = "Пользовательская сортировка"
	L.FILTER_BUILDER_COPY_SUFFIX = "Копия"
	L.FILTER_BUILDER_PREVIEW_COUNT = "Предпросмотр: подходит друзей — %d из %d"
	L.FILTER_BUILDER_PREVIEW_SORTER = "Предпросмотр выбранной сортировки"
	L.FILTER_BUILDER_PREVIEW_APPLY = "Предпросмотр"
	L.FILTER_BUILDER_PREVIEW_STOP = "Остановить предпросмотр"
	L.FILTER_BUILDER_BUILTIN_LOCKED = "Встроенные варианты можно показывать, скрывать, переставлять и копировать. Создайте копию, чтобы изменить правила."
	L.FILTER_BUILDER_CREATE_FILTER_TITLE = "Создать быстрый фильтр"
	L.FILTER_BUILDER_CREATE_SORTER_TITLE = "Создать сортировку"
	L.FILTER_BUILDER_CREATE = "Создать"
	L.FILTER_BUILDER_TEMPLATE = "Шаблон"
	L.FILTER_BUILDER_TEMPLATE_BLANK = "Пустой"
	L.FILTER_BUILDER_VALUE_TRUE = "Да"
	L.FILTER_BUILDER_VALUE_FALSE = "Нет"
	L.FILTER_BUILDER_DIRECTION_ASC = "По возрастанию"
	L.FILTER_BUILDER_DIRECTION_DESC = "По убыванию"
	L.FILTER_BUILDER_EMPTY_FIRST = "Пустые сначала"
	L.FILTER_BUILDER_EMPTY_LAST = "Пустые в конце"
	L.FILTER_BUILDER_OP_IS = "Равно"
	L.FILTER_BUILDER_OP_ISNOT = "Не равно"
	L.FILTER_BUILDER_OP_CONTAINS = "Содержит"
	L.FILTER_BUILDER_OP_NOTCONTAINS = "Не содержит"
	L.FILTER_BUILDER_OP_STARTS = "Начинается с"
	L.FILTER_BUILDER_OP_ENDS = "Заканчивается на"
	L.FILTER_BUILDER_OP_EMPTY = "Пусто"
	L.FILTER_BUILDER_OP_NOTEMPTY = "Не пусто"
	L.FILTER_BUILDER_OP_GT = "Больше"
	L.FILTER_BUILDER_OP_GTE = "Больше или равно"
	L.FILTER_BUILDER_OP_LT = "Меньше"
	L.FILTER_BUILDER_OP_LTE = "Меньше или равно"
	L.FILTER_BUILDER_OP_BETWEEN = "Между"
	L.FILTER_BUILDER_OP_IN = "В списке"
	L.FILTER_BUILDER_OP_NOTIN = "Не в списке"
	L.ICON_SELECTOR_TITLE = "Выберите значок"
	L.ICON_SELECTOR_BLIZZARD = "Blizzard"
	L.FILTER_BUILDER_FIELD_TYPE = "Тип"
	L.FILTER_BUILDER_FIELD_ONLINE = "В сети"
	L.FILTER_BUILDER_FIELD_STATUS = "Статус"
	L.FILTER_BUILDER_FIELD_AFK = "Отсутствует"
	L.FILTER_BUILDER_FIELD_DND = "Не беспокоить"
	L.FILTER_BUILDER_FIELD_MOBILE = "Мобильный"
	L.FILTER_BUILDER_FIELD_FAVORITE = "Избранное"
	L.FILTER_BUILDER_FIELD_GROUP = "Группа"
	L.FILTER_BUILDER_FIELD_NOTE = "Заметка"
	L.FILTER_BUILDER_FIELD_NICKNAME = "Псевдоним"
	L.FILTER_BUILDER_FIELD_BATTLETAG = "BattleTag"
	L.FILTER_BUILDER_FIELD_CHARACTER = "Персонаж"
	L.FILTER_BUILDER_FIELD_REALM = "Игровой мир"
	L.FILTER_BUILDER_FIELD_LEVEL = "Уровень"
	L.FILTER_BUILDER_FIELD_ZONE = "Зона"
	L.FILTER_BUILDER_FIELD_CLASS = "Класс"
	L.FILTER_BUILDER_FIELD_FACTION = "Фракция"
	L.FILTER_BUILDER_FIELD_GUILD = "Гильдия"
	L.FILTER_BUILDER_FIELD_CLIENT = "Клиент"
	L.FILTER_BUILDER_FIELD_GAME = "Игра"
	L.FILTER_BUILDER_FIELD_WOW_PROJECT = "Версия WoW"
	L.FILTER_BUILDER_FIELD_MULTI_ACCOUNT = "Несколько записей"
	L.FILTER_BUILDER_FIELD_LAST_ONLINE = "Последний вход"
	L.FILTER_BUILDER_FIELD_RECENTLY_ADDED = "Недавно добавлен"
	L.FILTER_BUILDER_FIELD_ACCOUNT_COUNT = "Число записей"
	L.SETTINGS_CENTER_PAGE_FRIENDS_DISPLAY_DESC = "Настройка видимых данных в строках друзей и состояния списка."
	L.SETTINGS_CENTER_PAGE_FRIENDS_FORMATTING_DESC = "Настройка отображения имён и дополнительной информации."
	L.SETTINGS_CENTER_PAGE_FRIENDS_BEHAVIOR_DESC = "Настройка компактного режима, поведения окна и действий мыши."
	L.SETTINGS_CENTER_PAGE_APPEARANCE_THEME_DESC = "Настройка оформления BetterFriendlist."
	L.SETTINGS_CENTER_PAGE_APPEARANCE_FONTS_DESC = "Настройка шрифтов списка друзей, вкладок, рейда и заголовков групп."
	L.SETTINGS_CENTER_PAGE_APPEARANCE_FRAME_DESC = "Настройка размера, масштаба и перемещения окна BetterFriendlist."
	L.SETTINGS_CENTER_PAGE_GROUPS_BUILTINS_DESC = "Настройка автоматических групп BetterFriendlist."
	L.SETTINGS_CENTER_PAGE_GROUPS_HEADERS_DESC = "Настройка счётчиков, стрелок и выравнивания заголовков групп."
	...
	L.MENU_EXTERNAL_ADDONS = "Модификации"
	L.SETTINGS_EXTERNAL_MENU_BRIDGE = "Интеграция меню сторонних модификаций (бета)"
	L.SETTINGS_EXTERNAL_MENU_BRIDGE_DESC = "Добавляет действия совместимых модификаций в поддерживаемые контекстные меню BetterFriendlist."
	L.CONTACT_MEMORY_TITLE = "Личные заметки"
	L.CONTACT_MEMORY_MENU_TITLE = "Заметки и метки"
	L.CONTACT_MEMORY_EDIT_NOTE = "Изменить личную заметку"
	L.CONTACT_MEMORY_CLEAR_NOTE = "Очистить личную заметку"
	L.CONTACT_MEMORY_NOTE_PROMPT = "Личная заметка для %s:"
	L.CONTACT_MEMORY_TOOLTIP_TITLE = "Заметки и метки"
	L.CONTACT_MEMORY_SETTINGS_ENABLE = "Личные заметки (бета)"
	L.CONTACT_MEMORY_SETTINGS_ENABLE_DESC = "Добавляет локальные личные заметки для друзей и игнорируемых игроков."
	L.CONTACT_MEMORY_SETTINGS_TOOLTIPS = "Показывать в подсказках"
	L.CONTACT_MEMORY_SETTINGS_TOOLTIPS_DESC = "Показывает личные заметки в поддерживаемых подсказках друзей и списка игнорирования."
	L.CONTACT_MEMORY_SETTINGS_HIDE_STREAMER = "Скрывать в режиме стримера"
	L.CONTACT_MEMORY_SETTINGS_HIDE_STREAMER_DESC = "Скрывает личные заметки, пока активен режим стримера."
	L.CONTACT_MEMORY_DISABLED_BETA = "Включите бета-функции, чтобы использовать личные заметки."
	L.FRIEND_TAGS_TITLE = "Метки друзей"
	L.FRIEND_TAGS_MENU_TITLE = "Метки друзей"
	L.FRIEND_TAGS_MENU_TITLE_COUNT = "Метки друзей (%d)"
	L.FRIEND_TAGS_BLIZZARD_SECTION = "Метки Blizzard"
	L.FRIEND_TAGS_BLIZZARD_COMPAT_SECTION = "Метки, совместимые с Blizzard"
	L.FRIEND_TAGS_CUSTOM_SECTION = "Пользовательские метки"
	L.FRIEND_TAGS_CREATE_CUSTOM = "Создать метку"
	L.FRIEND_TAGS_CUSTOM_PROMPT = "Создать пользовательскую метку для %s:"
	L.FRIEND_TAGS_NO_CUSTOM_TAGS = "Пользовательских меток пока нет"
	L.FRIEND_TAGS_SELECT_ALL = "Выбрать все"
	L.FRIEND_TAGS_CLEAR_ALL = "Снять выбор"
	L.FRIEND_TAGS_NAME_RESERVED_ERROR = "Это имя уже используется встроенной меткой."
	L.FRIEND_TAGS_TOOLTIP_TITLE = "Метки друзей"
	L.FRIEND_TAGS_SETTINGS_GENERAL = "Метки друзей"
	L.FRIEND_TAGS_SETTINGS_ENABLE = "Метки друзей"
	L.FRIEND_TAGS_SETTINGS_ENABLE_DESC = "Добавляет друзьям совместимые с Blizzard и пользовательские метки."
	L.FRIEND_TAGS_SETTINGS_ROW_CHIPS = "Показывать метки в строках"
	L.FRIEND_TAGS_SETTINGS_ROW_CHIPS_DESC = "Показывает компактные метки под строкой информации о друге."
	L.FRIEND_TAGS_SETTINGS_MAX_ROW_CHIPS = "Максимум меток в строке"
	L.FRIEND_TAGS_SETTINGS_MAX_ROW_CHIPS_DESC = "Ограничивает число меток в строке друга до появления счётчика +число."
	L.FRIEND_TAGS_SETTINGS_TOOLTIPS = "Показывать в подсказках"
	...
	L.FRIEND_TAGS_SETTINGS_SEARCH_CUSTOM_DESC = "Учитывает пользовательские метки BetterFriendlist при поиске по списку друзей."
	L.FRIEND_TAGS_SETTINGS_STREAMER = "Показывать в режиме стримера"
	L.FRIEND_TAGS_SETTINGS_STREAMER_DESC = "Оставляет метки друзей видимыми в режиме стримера."
	L.FRIEND_TAGS_SETTINGS_BROKER = "Показывать в подсказках брокера"
	L.FRIEND_TAGS_SETTINGS_BROKER_DESC = "Позволяет поддерживаемым интеграциям брокера показывать метки друзей."
	L.FRIEND_TAGS_BLIZZARD_PROFESSIONS = "Профессии"
	L.FRIEND_TAGS_BLIZZARD_PVP = "PvP"
	L.FRIEND_TAGS_BLIZZARD_RAIDING = "Рейды"
	L.FRIEND_TAGS_BLIZZARD_DUNGEONS = "Подземелья"
	L.FRIEND_TAGS_BLIZZARD_DELVES = "Вылазки"
	L.FRIEND_TAGS_BLIZZARD_QUESTING = "Задания"
	L.FRIEND_TAGS_BLIZZARD_ROLEPLAYING = "Ролевая игра"
	L.FRIEND_TAGS_BLIZZARD_DAMAGER = "DPS"
	L.FRIEND_TAGS_BLIZZARD_HEALER = "Лекарь"
	L.FRIEND_TAGS_BLIZZARD_TANK = "Танк"
	L.SETTINGS_CENTER_PAGE_FRIEND_TAGS = "Метки друзей"
	L.SETTINGS_CENTER_PAGE_FRIEND_TAGS_DESC = "Настройка меток друзей, совместимых меток Blizzard и меток в строках."
	L.SETTINGS_TAB_FRIEND_TAGS = "Метки друзей"
	L.FRIEND_TAGS_ENABLE = "Включить метки друзей"
	L.FRIEND_TAGS_ENABLE_DESC = "Добавляет друзьям совместимые с Blizzard и пользовательские метки."
	L.FRIEND_TAGS_REQUIRES_CONTACT_MEMORY = "Сначала включите личные заметки, чтобы использовать метки друзей."
	L.FRIEND_TAGS_SETTINGS_DESC = "Настройте совместимые с Blizzard и пользовательские метки, а также их компактное отображение."
	L.FRIEND_TAGS_SETTINGS_VISIBILITY = "Видимость"
	L.FRIEND_TAGS_SHOW_ROW_CHIPS = "Показывать метки в строках"
	L.FRIEND_TAGS_SHOW_ROW_CHIPS_DESC = "Показывает компактные метки под строками друзей."
	L.FRIEND_TAGS_SHOW_TOOLTIP_CHIPS = "Показывать метки в подсказках"
	L.FRIEND_TAGS_SHOW_TOOLTIP_CHIPS_DESC = "Показывает метки в подсказках BetterFriendlist."
	L.FRIEND_TAGS_SHOW_BROKER_CHIPS = "Показывать метки в брокере"
	L.FRIEND_TAGS_SHOW_BROKER_CHIPS_DESC = "Показывает метки в подсказке Data Broker."
	L.FRIEND_TAGS_STREAMER_MODE = "Показывать в режиме стримера"
	L.FRIEND_TAGS_STREAMER_MODE_DESC = "Разрешает метки друзей в режиме стримера."
	L.FRIEND_TAGS_SETTINGS_COMPACT_MODE = "Компактные строки"
	L.FRIEND_TAGS_SETTINGS_COMPACT_MODE_DESC = "Выберите способ отображения меток в компактных строках BetterFriendlist."
	L.FRIEND_TAGS_COMPACT_HIDDEN = "Скрыто"
	L.FRIEND_TAGS_COMPACT_ICON_ONLY = "Только значки"
	L.FRIEND_TAGS_COMPACT_CHIP_LINE = "Строка меток"
	L.FRIEND_TAGS_MAX_ROW_CHIPS = "Максимум меток в строке"
	L.FRIEND_TAGS_CHIPS_PER_LINE = "Метки на одной строке"
	L.FRIEND_TAGS_CHIPS_PER_LINE_DESC = "Ограничивает число меток в каждой строке независимо от общего лимита меток ряда."
	L.FRIEND_TAGS_FULL_WIDTH_ROWS = "Строки меток на всю ширину"
	L.FRIEND_TAGS_FULL_WIDTH_ROWS_DESC = "Размещает метки в отдельных строках на всю ширину карточки друга."
	L.FRIEND_TAGS_CHIP_ICON_SIZE = "Размер меток и значков"
	L.FRIEND_TAGS_CHIP_ICON_SIZE_DESC = "Задаёт размер значков в метках списка друзей и в предпросмотре редактора."
	L.FRIEND_TAGS_CHIP_FONT_SIZE = "Размер шрифта меток"
	L.FRIEND_TAGS_CHIP_FONT_SIZE_DESC = "Задаёт размер текста в метках списка друзей и в предпросмотре редактора."
	L.FRIEND_TAGS_HIDE_DYNAMIC_GROUP_TAG = "Скрывать метку группы"
	L.FRIEND_TAGS_HIDE_DYNAMIC_GROUP_TAG_DESC = "Скрывает только метку, которая образует текущую динамическую группу."
	L.FRIEND_TAGS_HIDE_ALL_DYNAMIC_GROUP_TAGS = "Скрывать все метки в динамических группах"
	L.FRIEND_TAGS_HIDE_ALL_DYNAMIC_GROUP_TAGS_DESC = "Скрывает все плашки меток в строках динамических групп меток."
	L.FRIEND_TAGS_MAX_TOOLTIP_CHIPS = "Максимум меток в подсказке"
	L.FRIEND_TAGS_SETTINGS_GROUPS = "Динамические группы меток"
	L.FRIEND_TAGS_SETTINGS_DYNAMIC_GROUPS = "Показывать динамические группы меток"
	L.FRIEND_TAGS_SETTINGS_DYNAMIC_GROUPS_DESC = "Добавляет виртуальные группы назначенных меток без записи групп в заметки Blizzard."
	L.FRIEND_TAGS_SHOW_MENU_COUNTS = "Показывать число в меню"
	L.FRIEND_TAGS_SHOW_MENU_COUNTS_DESC = "Показывает число назначенных меток в поддерживаемых контекстных меню."
	L.FRIEND_TAGS_SEARCH_BLIZZARD = "Искать метки Blizzard"
	L.FRIEND_TAGS_SEARCH_BLIZZARD_DESC = "Учитывает совместимые с Blizzard метки при поиске друзей."
	L.FRIEND_TAGS_SEARCH_CUSTOM = "Искать пользовательские метки"
	L.FRIEND_TAGS_SEARCH_CUSTOM_DESC = "Учитывает пользовательские метки при поиске друзей."
	L.FRIEND_TAGS_SETTINGS_EDITOR = "Редактор меток"
	L.FRIEND_TAGS_EDITOR_TITLE = "Метки друзей"
	L.FRIEND_TAGS_EDITOR_DESC = "Настройте подписи, значки, цвета, видимость и порядок меток."
	L.FRIEND_TAGS_EDITOR_OPEN = "Настроить метки"
	L.FRIEND_TAGS_EDITOR_EDIT = "Изменить"
	L.FRIEND_TAGS_EDITOR_RESET = "Сбросить"
	L.FRIEND_TAGS_EDITOR_DELETE = "Удалить"
	L.FRIEND_TAGS_EDITOR_CREATE_PROMPT = "Создайте новую пользовательскую метку друга:"
	L.FRIEND_TAGS_EDITOR_DELETE_PROMPT = "Удалить пользовательскую метку «%s»? Все её назначения будут удалены."
	L.FRIEND_TAGS_EDITOR_NAME = "Название"
	L.FRIEND_TAGS_EDITOR_LABEL = "Подпись метки"
	L.FRIEND_TAGS_EDITOR_LABEL_DEFAULT = "Стандартная подпись"
	L.FRIEND_TAGS_EDITOR_LABEL_ICON_ONLY = "Только значок"
	L.FRIEND_TAGS_EDITOR_ICON_ONLY_CHIP = "Сохранять цвет плашки"
	L.FRIEND_TAGS_EDITOR_ICON_ONLY_CHIP_DESC = "Сохраняет цветной фон плашки, когда для этой метки выбран режим «Только значок»."
	L.FRIEND_TAGS_EDITOR_ICON = "Значок"
	L.FRIEND_TAGS_EDITOR_ICON_CUSTOM = "Путь к своему значку"
	L.FRIEND_TAGS_EDITOR_COLOR = "Цвет метки"
	L.FRIEND_TAGS_EDITOR_TEXT_COLOR = "Цвет шрифта метки"
	L.FRIEND_TAGS_EDITOR_VISIBLE = "Видимость"
	L.FRIEND_TAGS_EDITOR_ROW_VISIBLE = "Строки"
	L.FRIEND_TAGS_EDITOR_TOOLTIP_VISIBLE = "Подсказки"
	L.FRIEND_TAGS_EDITOR_BROKER_VISIBLE = "Брокер"
	L.FRIEND_TAGS_EDITOR_VISIBLE_DESC = "Главный переключатель этой метки на всех поверхностях отображения."
	L.FRIEND_TAGS_EDITOR_ROW_VISIBLE_DESC = "Показывает эту метку в строках друзей, когда включена общая видимость."
	L.FRIEND_TAGS_EDITOR_TOOLTIP_VISIBLE_DESC = "Показывает эту метку в поддерживаемых подсказках друзей, когда включена общая видимость."
	L.FRIEND_TAGS_EDITOR_BROKER_VISIBLE_DESC = "Показывает эту метку в подсказке Data Broker, когда включена общая видимость."
	L.FRIEND_TAGS_EDITOR_ORDER = "Порядок"
	L.FRIEND_TAGS_EDITOR_PREVIEW_HIDDEN = "Предпросмотр скрыт"
	L.FRIEND_TAGS_SETTINGS_TAG_LIST = "Метки"
	L.FRIEND_TAGS_SETTINGS_TAG_LIST_DESC = "Перемещайте метки, открывайте редактор или сбрасывайте пользовательские параметры."
	L.FRIEND_TAGS_SETTINGS_TAG_LIST_EMPTY = "Нет доступных меток."
	L.FRIEND_TAGS_SOURCE_BLIZZARD = "Blizzard"
	L.FRIEND_TAGS_SOURCE_CUSTOM = "Пользовательская"
	L.FRIEND_TAGS_SYNC_LOCAL_TITLE = "Передача в Blizzard 12.1"
	L.FRIEND_TAGS_SYNC_LOCAL_BUTTON = "Синхронизировать локальные метки Blizzard"
	L.FRIEND_TAGS_SYNC_LOCAL_DESC = "Переносит локальные совместимые метки в стандартное хранилище меток Blizzard 12.1."
	L.FRIEND_TAGS_SYNC_TO_BLIZZARD = "Синхронизировать с Blizzard"
	L.FRIEND_TAGS_INTERESTS_SECTION = "Интересы"
	L.FRIEND_TAGS_ROLES_SECTION = "Роли"
	L.FRIEND_TAGS_MANAGE = "Управление метками"
	L.FRIEND_TAGS_CREATE_CUSTOM_TAG = "Создать метку"
	L.FRIEND_TAGS_DYNAMIC_GROUP_TOOLTIP = "Динамическая группа меток друзей. Назначения хранятся как метки, а не как группы друзей."
	L.FRIEND_TAGS_ICON_TAG = "Метка"
	L.FRIEND_TAGS_ICON_PROFESSIONS = "Профессии"
	L.FRIEND_TAGS_ICON_PVP = "PvP"
	L.FRIEND_TAGS_ICON_RAID = "Рейд"
	L.FRIEND_TAGS_ICON_DUNGEON = "Подземелье"
	L.FRIEND_TAGS_ICON_DELVES = "Вылазки"
	L.FRIEND_TAGS_ICON_QUESTING = "Задания"
	L.FRIEND_TAGS_ICON_ROLEPLAYING = "Ролевая игра"
	L.FRIEND_TAGS_ICON_DAMAGER = "Урон"
	L.FRIEND_TAGS_ICON_HEALER = "Исцеление"
	L.FRIEND_TAGS_ICON_TANK = "Танк"
	L.FILTER_BUILDER_FIELD_TAG = "Метка"
	L.FILTER_BUILDER_FIELD_TAG_SOURCE = "Источник метки"
	L.FILTER_BUILDER_FIELD_TAG_COUNT = "Число меток"
	L.FILTER_BUILDER_FIELD_HAS_TAG = "Есть метка"
	L.AUTO_RAID_ASSIST_TITLE = "Автоматический помощник рейда"
	L.AUTO_RAID_ASSIST_DESC = "Автоматически повышает выбранных друзей и персонажей до помощника рейда, когда они вступают в ваш рейд."
	L.AUTO_RAID_ASSIST_ENABLE = "Включить автоматического помощника рейда"
	L.AUTO_RAID_ASSIST_ENABLE_DESC = "Автоматически повышает выбранных друзей и персонажей до помощника рейда, когда они вступают в ваш рейд."
	L.AUTO_RAID_ASSIST_MANAGE = "Настроить автоматического помощника"
	L.AUTO_RAID_ASSIST_MANAGE_DESC = "Выберите друзей BattleTag, совпадения по псевдониму или цели в формате Персонаж-Мир."
	L.AUTO_RAID_ASSIST_MANAGE_BUTTON = "Настроить"
	L.AUTO_RAID_ASSIST_SEARCH_LABEL = "Найти друга"
	L.AUTO_RAID_ASSIST_RESULTS = "Друзья"
	L.AUTO_RAID_ASSIST_TARGETS = "Цели"
	L.AUTO_RAID_ASSIST_MANUAL_LABEL = "Персонаж-Мир"
	L.AUTO_RAID_ASSIST_ADD = "Добавить"
	L.AUTO_RAID_ASSIST_REMOVE = "Удалить"
	L.AUTO_RAID_ASSIST_NO_RESULTS = "Подходящих друзей нет"
	L.AUTO_RAID_ASSIST_NO_TARGETS = "Цели не выбраны"
	L.AUTO_RAID_ASSIST_INVALID_CHARACTER = "Используйте формат Имя-Мир."
	L.AUTO_RAID_ASSIST_DUPLICATE = "Уже выбрано."
	L.AUTO_RAID_ASSIST_BNET = "BattleTag"
	L.AUTO_RAID_ASSIST_WOW = "Друг WoW"
	L.AUTO_RAID_ASSIST_MANUAL = "Вручную"
	L.KEYBIND_TOGGLE_BETTERFRIENDLIST = "Показать или скрыть BetterFriendlist"
	-- ========================================
	-- SETTINGS PANEL
	-- ========================================
	...
	L.STATS_ONLINE_OFFLINE = "|cff00ff00В сети: %d (%d%%)|r  |  |cff808080Не в сети: %d (%d%%)|r"
	...
	L.BROKER_SETTINGS_FONT_HEADER = "Шрифт подсказки брокера"
	L.BROKER_SETTINGS_FONT = "Шрифт:"
	L.BROKER_SETTINGS_FONT_TOOLTIP = "Выберите шрифт для подсказок брокера"
	L.BROKER_SETTINGS_FONT_SIZE = "Размер шрифта:"
	L.BROKER_SETTINGS_FONT_SIZE_TOOLTIP = "Задайте размер шрифта в подсказках брокера"
	L.BROKER_SETTINGS_FONT_NON_LATIN = "Использовать шрифт для нелатинских алфавитов"
	L.BROKER_SETTINGS_FONT_NON_LATIN_TOOLTIP =
		"Использует выбранный шрифт подсказки брокера для корейского, китайского и русского текста вместо стандартного резервного шрифта WoW."
	L.BROKER_SETTINGS_FONT_NON_LATIN_WARNING =
		"Шрифты поддерживают не все алфавиты. Если вместо текста видны квадраты, выберите другой шрифт или отключите эту настройку."
	L.BROKER_SETTINGS_APPEARANCE_HEADER = "Оформление подсказки брокера"
	L.BROKER_SETTINGS_SEPARATOR_COLOR = "Цвет разделителя"
	L.BROKER_SETTINGS_SEPARATOR_COLOR_TOOLTIP = "Задаёт общий цвет разделителей групп и нижних разделителей в брокерах друзей и гильдии."
	L.BROKER_SETTINGS_SEPARATOR_RESET_TOOLTIP = "Щёлкните правой кнопкой, чтобы сбросить цвет разделителя."
	L.BROKER_SETTINGS_GROUP_HEADER_ALIGN = "Выравнивание названий групп"
	L.BROKER_SETTINGS_GROUP_HEADER_ALIGN_TOOLTIP = "Задайте выравнивание названий групп в подсказке брокера друзей"
	...
	L.GUILD_BROKER_SETTINGS_SHOW_APPLICANTS = "Показывать число кандидатов"
	L.GUILD_BROKER_SETTINGS_SHOW_APPLICANTS_DESC = "Показывает число ожидающих кандидатов в гильдию в тексте брокера, когда оно доступно"
	...
	L.GUILD_BROKER_LAST_ONLINE_YEARS = "%d г."
	L.GUILD_BROKER_LAST_ONLINE_MONTHS = "%d мес."
	L.GUILD_BROKER_LAST_ONLINE_DAYS = "%d д."
	L.GUILD_BROKER_LAST_ONLINE_HOURS = "%d ч."
	...
	L.BROKER_SETTINGS_INFO =
		"BetterFriendlist интегрируется с брокерами данных, такими как Bazooka, Arcana и Titan Panel."
	...
	L.EDIT_MODE_NOT_AVAILABLE = "Режим редактирования недоступен в Classic. Используйте /bfl position, чтобы переместить окно."
	...
	L.SETTINGS_ENABLE_GUILD_TAB = "Состав гильдии (бета)"
	...
	L.STATS_GAME_MOBILE = "\\nМобильное приложение: %d"
	L.STATS_GAME_OTHER = "\nДругие: %d"
	L.STATS_MOBILE_DESKTOP = "ПК: %d (%d%%)\\nМобильное приложение: %d (%d%%)"
	...
	L.STATS_MOBILE_HEADER = "Мобильное приложение и ПК"
	...
	L.CORE_BETA_ENABLE_HINT = "|cffffcc00Включение:|r ESC > Модификации > BFL > Дополнительно > Бета-функции"
	...
	L.CORE_STATS_TOTAL_ONLINE_OFFLINE =
		"  Всего: |cffffffff%d|r  В сети: |cff00ff00%d|r (%.0f%%)  Не в сети: |cffaaaaaa%d|r (%.0f%%)"
	L.CORE_STATS_BNET_WOW = "  BNet: |cff0099ff%d|r  |  WoW: |cffffd700%d|r"
	L.CORE_STATS_FRIENDSHIP_HEALTH = "|cffffcc00Здоровье:|r"
	L.CORE_STATS_HEALTH_ACTIVE = "  Активные: |cff00ff00%d|r (%.0f%%)  Постоянные: |cffffd700%d|r (%.0f%%)  Отдаляющиеся: |cffffaa00%d|r (%.0f%%)"
	L.CORE_STATS_HEALTH_STALE = "  Давно неактивные: |cffff6600%d|r (%.0f%%)  Спящие: |cffff0000%d|r (%.0f%%)"
	...
	L.CORE_STATS_REALM_BREAKDOWN = "  Тот же игровой мир: |cffffffff%d|r (%.0f%%)  |  Другие миры: |cffffffff%d|r (%.0f%%)"
	...
	L.CORE_STATS_MOBILE_VS_DESKTOP = "|cffffcc00Мобильное приложение и ПК:|r"
	L.CORE_STATS_MOBILE_DATA = "  ПК: |cffffffff%d|r (%.0f%%)  Мобильное приложение: |cffffffff%d|r (%.0f%%)"
	L.CORE_STATS_ORGANIZATION = "|cffffcc00Организация:|r"
	L.CORE_STATS_ORG_DATA = "  С заметками: |cffffffff%d|r (%.0f%%)  Избранные: |cffffffff%d|r (%.0f%%)"
	L.CORE_SETTINGS_NOT_LOADED = "Конфигурация не загружена"
	L.CORE_MOCK_INVITES_ENABLED = "Имитация приглашений |cff00ff00ON|r"
	L.CORE_MOCK_INVITE_ADDED = "Добавлено тестовое приглашение от |cffffffff%s|r (всего: %d)"
	L.CORE_MOCK_INVITE_TIP = "|cffffcc00Подсказка:|r Используйте |cffffffff/bfl clearinvites|r, чтобы удалить все тестовые приглашения."
	L.CORE_MOCK_INVITES_CLEARED = "Удалено тестовых приглашений: %d — тестовая система |cffff0000ОТКЛЮЧЕНА|r"
	...
	L.CORE_HELP_CMD_SETTINGS = "  |cffffffff/bfl settings|r - Открыть настройки"
	L.CORE_HELP_CMD_HELP = "  |cffffffff/bfl help|r - Показать справку"
	L.CORE_HELP_CMD_CHANGELOG = "  |cffffffff/bfl changelog|r - Открыть журнал изменений"
	L.CORE_HELP_CMD_RESET = "  |cffffffff/bfl reset|r - Сбросить позицию окна"
	L.CORE_HELP_DEBUG_COMMANDS = "|cffffcc00Отладка:|r"
	L.CORE_HELP_CMD_DEBUG = "  |cffffffff/bfl debug|r - Включить отладку"
	...
	L.CORE_HELP_QJ_COMMANDS = "|cffffcc00Быстрое присоединение:|r"
	...
	L.CORE_HELP_QJ_EVENT = "  |cffffffff/bfl qj event add|remove|update|r - Симулировать события"
	L.CORE_HELP_QJ_CLEAR = "  |cffffffff/bfl qj clear|r - Очистить"
	L.CORE_HELP_QJ_LIST = "  |cffffffff/bfl qj list|r - Список"
	L.CORE_HELP_MOCK_COMMANDS = "|cffffcc00Тестовые данные:|r"
	L.CORE_HELP_MOCK_OLD = "  |cffffffff/bfl mock|r - Создать тестовый рейд (устарело, аналог /bfl raid mock)"
	...
	L.CORE_HELP_PREVIEW_COMMANDS = "|cffffcc00Режим предпросмотра:|r"
	L.CORE_HELP_PREVIEW_ON = "  |cffffffff/bfl preview|r - Вкл"
	L.CORE_HELP_PREVIEW_OFF = "  |cffffffff/bfl preview off|r - Выкл"
	L.CORE_HELP_PREVIEW_DESC = "  |cff888888(Показывает тестовые данные)|r"
	L.CORE_HELP_RAID_COMMANDS = "|cffffcc00Команды окна рейда:|r"
	...
	L.CORE_HELP_PERF_COMMANDS = "|cffffcc00Производительность:|r"
	...
	L.CORE_HELP_TEST_COMMANDS = "|cffffcc00Тестовые команды:|r"
	...
	L.CORE_HELP_LINK = "|cff20ff20Дополнительная справка:|r |cff00ccffhttps://github.com/Hayato2846/BetterFriendlist|r"
	L.CORE_LOADED = "|cff00ff00BetterFriendlist v%s%s|r. Загружено. Discord: /bfl discord"

	-- Performance Monitor
	L.PERF_STATS_RESET = "Сброс статистики"
	L.PERF_REPORT_HEADER = "|cff00ff00=== Отчёт о производительности BetterFriendlist ===|r"
	L.PERF_QJ_OPS = "|cffffd700Операции быстрого присоединения:|r"
	L.PERF_FRIENDS_OPS = "|cffffd700Операции списка друзей:|r"
	...
	L.RAID_HELP_EVENTS = "|cffffcc00Симуляция событий:|r"
	L.RAID_CONFIG_HEADER = "|cff00ff00Настройка тестового рейда BFL:|r"
	L.RAID_INFO_HEADER = "|cff00ff00Сведения о тестовом рейде BFL:|r"
	L.RAID_NO_MOCK_ACTIVE = "|cff888888Окно рейда BFL:|r Нет активных тестовых данных. Используйте '/bfl raid mock', чтобы создать их."
	...
	L.RAID_COMPOSITION = "  Состав: танки — %d, лекари — %d, бойцы — %d"
	...
	L.QJ_SIM_UPDATED_FMT = "Симуляция: %s обновлена (участников: %d)"
	L.QJ_ADDED_GROUP_FMT = "Добавлена тестовая группа: %s — %s (участников: %d)"
	L.QJ_NO_GROUPS_HINT = "Нет тестовых групп. Используйте '/bfl qj mock', чтобы создать тестовые данные."
	L.QJ_MOCK_ICONS_HELP = "  |cffffcc00/bfl qj mock icons|r - Иконки"
	L.HELP_HEADER_CONFIGURATION = "|cffffcc00Настройка:|r"
	...
	-- ClassicCompat.lua
	L.PERF_HEADER_PREFIX = "|cff00ff00Производительность:|r"
	L.COMPAT_GAME_VERSION = "|cffffcc00Версия:|r"
	-- ========================================
	...
	L.INFO_MULTI_ACCOUNT_PREFIX = "×%d записей"
	...
	L.WHO_BUILDER_NAME_PLACEHOLDER = "Поиск по имени персонажа"
	L.WHO_BUILDER_GUILD_PLACEHOLDER = "Поиск по названию гильдии"
	L.WHO_BUILDER_ZONE_PLACEHOLDER = "Поиск по зоне"
	...
	L.SETTINGS_TAINT_FREE_WHISPER_DESC =
		"Использует собственное поле шепота BFL на месте строки ввода чата вместо открытия редактора чата Blizzard. BFL не изменяет ни стандартную строку ввода, ни состояние чата. Нажмите Enter для отправки или Escape для отмены. В Classic или если позицию чата определить нельзя, панель остаётся в списке друзей."
	L.SETTINGS_TAINT_FREE_WHISPER_TOOLTIP =
		"Предотвращает тейнт чата, отделяя ввод шепота от строки чата Blizzard. В Retail поле появляется на месте стандартной строки ввода."
	...
	L.GUILD_HEADER_ONLINE_FORMAT = "%d / %d в сети"
	L.GUILD_MOTD_TOOLTIP_HEADER = "Сообщение дня"
	L.GUILD_COLUMN_AP = "AP"
	L.GUILD_COLUMN_ILVL = "iLvl"
	L.GUILD_FILTER_ALL = "Все"
	L.GUILD_FILTER_ONLINE = "В сети"
	L.GUILD_FILTER_OFFLINE = "Не в сети"
	L.GUILD_INFO_PANEL_TITLE = "Информация об участнике"
	L.GUILD_INFO_PUBLIC_NOTE = "Общая заметка"
	L.GUILD_INFO_OFFICER_NOTE = "Офицерская заметка"
	L.GUILD_INFO_NICKNAME = "Псевдоним"
	L.GUILD_INFO_SAVE = "Сохранить"
	L.GUILD_INFO_EDIT = "Изменить"
	L.GUILD_INFO_CANCEL = "Отмена"
	L.GUILD_INFO_NO_NOTE = "Заметка не задана."
	L.GUILD_INFO_ACHIEVEMENTS = "Очки достижений"
	L.GUILD_INFO_ILVL_UNKNOWN = "-"
L.GUILD_INFO_ILVL = "Уровень предметов"
L.GUILD_INFO_RANK = "Ранг"
L.SETTINGS_SHOW_GUILD_TABARD = "Показывать герб гильдии"
L.SETTINGS_SHOW_GUILD_TABARD_DESC = "Показывает герб гильдии в заголовке вкладки гильдии."
L.SETTINGS_SHOW_ILVL_COLUMN = "Показывать уровень предметов"
L.SETTINGS_SHOW_ILVL_COLUMN_DESC = "Показывает столбец уровня предметов в списке вкладки гильдии."
	L.GUILD_ACTION_WHISPER = "Шёпот"
	L.GUILD_ACTION_INVITE_PARTY = "Пригласить в группу"
	L.GUILD_ACTION_PROMOTE = "Повысить"
	L.GUILD_ACTION_DEMOTE = "Понизить"
	L.GUILD_ACTION_REMOVE = "Исключить из гильдии"
	L.GUILD_ACTION_TARGET = "Выбрать целью"
	L.GUILD_ACTION_COPY_NAME = "Копировать имя"
	L.GUILD_ACTION_OPEN_INFO = "Информация об участнике"
	L.GUILD_INVITE_DIALOG_TITLE = "Пригласить в %s"
	L.GUILD_INVITE_PLACEHOLDER = "Персонаж-Мир"
	L.GUILD_INVITE_BUTTON = "Пригласить"
	L.GUILD_INVITE_BOTTOM_BUTTON = "Пригласить игрока"
	L.GUILD_SETTING_SHOW_TABARD = "Показывать герб гильдии в заголовке"
	L.GUILD_SETTING_SHOW_TABARD_DESC = "Показывает герб рядом с названием гильдии в заголовке вкладки гильдии."
	L.GUILD_CONFIRM_PROMOTE = "Повысить %s?"
	L.GUILD_CONFIRM_DEMOTE = "Понизить %s?"
	L.GUILD_CONFIRM_REMOVE = "Введите %s, чтобы подтвердить исключение участника из гильдии:"
	L.GUILD_COPY_NAME_TITLE = "Копировать имя"
	L.GUILD_CONTEXT_SECTION_COMMUNICATION = "Общение"
	L.GUILD_CONTEXT_SECTION_MANAGEMENT = "Управление"
	L.GUILD_CONTEXT_SECTION_ADDON = "BetterFriendlist"
	L.SETTINGS_TAB_THEME = "Тема"
	L.SETTINGS_THEME_HEADER = "Тема"
	L.SETTINGS_THEME_DROPDOWN = "Тема"
	L.SETTINGS_THEME_DROPDOWN_DESC = "Выберите оформление BetterFriendlist. Для ElvUI и EllesmereUI требуется перезагрузка интерфейса."
	L.SETTINGS_THEME_BLIZZARD = "Blizzard"
	L.SETTINGS_THEME_DARK = "Тёмная"
	L.SETTINGS_THEME_ELVUI = "ElvUI"
	L.SETTINGS_THEME_ELLESMEREUI = "EllesmereUI"
	L.SETTINGS_THEME_CUSTOM = "Пользовательская"
	L.SETTINGS_THEME_DARK_HEADER = "Настройки тёмной темы"
	L.SETTINGS_THEME_ACCENT_COLOR = "Акцентный цвет"
	L.SETTINGS_THEME_ACCENT_COLOR_DESC = "Настраивает цвет выделения, наведения, ползунков и значков."
	L.SETTINGS_THEME_WINDOW_OPACITY = "Прозрачность окна"
	L.SETTINGS_THEME_WINDOW_OPACITY_DESC = "Настраивает прозрачность основных окон BetterFriendlist."
	L.SETTINGS_THEME_POPUP_OPACITY = "Прозрачность окон и подсказок"
	L.SETTINGS_THEME_POPUP_OPACITY_DESC = "Настраивает прозрачность диалогов, всплывающих окон и подсказок BFL."
	L.SETTINGS_THEME_LIST_OPACITY = "Прозрачность списков и панелей"
	L.SETTINGS_THEME_LIST_OPACITY_DESC = "Настраивает прозрачность списков и внутренних панелей."
	L.SETTINGS_THEME_CONTROL_OPACITY = "Прозрачность элементов"
	L.SETTINGS_THEME_CONTROL_OPACITY_DESC = "Настраивает прозрачность кнопок, выпадающих списков, полей ввода и ползунков."
	L.SETTINGS_THEME_HOVER_STRENGTH = "Яркость при наведении"
	L.SETTINGS_THEME_HOVER_STRENGTH_DESC = "Настраивает заметность состояния наведения в тёмной и пользовательской темах."
	L.SETTINGS_THEME_SELECTION_STRENGTH = "Яркость выделения"
	L.SETTINGS_THEME_SELECTION_STRENGTH_DESC = "Настраивает заметность выбранных и нажатых элементов."
	L.SETTINGS_THEME_BORDER_STRENGTH = "Яркость границ"
	L.SETTINGS_THEME_BORDER_STRENGTH_DESC = "Настраивает прозрачность границ и разделителей."
	L.SETTINGS_THEME_ARTWORK_VISIBILITY = "Аватар BFL"
	L.SETTINGS_THEME_ARTWORK_VISIBILITY_DESC = "Настраивает видимость аватара BetterFriendlist, когда простой режим отключён."
	L.SETTINGS_THEME_RESET_DARK = "Сбросить тёмную тему"
	L.SETTINGS_THEME_CUSTOM_HEADER = "Своя тема"
	L.SETTINGS_THEME_CUSTOM_BACKGROUND = "Фон"
	L.SETTINGS_THEME_CUSTOM_BACKGROUND_DESC = "Заменяет цвет фона основного окна."
	L.SETTINGS_THEME_CUSTOM_SURFACE = "Панель"
	L.SETTINGS_THEME_CUSTOM_SURFACE_DESC = "Заменяет цвета дополнительных панелей и всплывающих окон."
	L.SETTINGS_THEME_CUSTOM_INSET = "Вставки и списки"
	L.SETTINGS_THEME_CUSTOM_INSET_DESC = "Заменяет цвета списков и внутренних панелей."
	L.SETTINGS_THEME_CUSTOM_CONTROL = "Элементы управления"
	L.SETTINGS_THEME_CUSTOM_CONTROL_DESC = "Заменяет цвета кнопок, выпадающих списков, полей ввода и ползунков."
	L.SETTINGS_THEME_CUSTOM_BORDER = "Граница"
	L.SETTINGS_THEME_CUSTOM_BORDER_DESC = "Заменяет цвета границ и разделителей."
	L.SETTINGS_THEME_CUSTOM_ACCENT = "Акцент"
	L.SETTINGS_THEME_CUSTOM_ACCENT_DESC = "Заменяет цвета выделения, ползунков и значков."
	L.SETTINGS_THEME_CUSTOM_TEXT = "Текст элементов"
	L.SETTINGS_THEME_CUSTOM_TEXT_DESC = "Заменяет цвет текста оформленных элементов управления."
	L.SETTINGS_THEME_CUSTOM_DISABLED_TEXT = "Неактивный текст"
	L.SETTINGS_THEME_CUSTOM_DISABLED_TEXT_DESC = "Заменяет цвет неактивного текста оформленных элементов управления."
	L.SETTINGS_THEME_CUSTOM_HOVER = "Наведение"
	L.SETTINGS_THEME_CUSTOM_HOVER_DESC = "Заменяет цвета элементов при наведении."
	L.SETTINGS_THEME_CUSTOM_SELECTED = "Выбранное и нажатое"
	L.SETTINGS_THEME_CUSTOM_SELECTED_DESC = "Заменяет цвета выбранных и нажатых элементов."
	L.SETTINGS_THEME_CUSTOM_SCROLL_THUMB = "Ползунок прокрутки"
	L.SETTINGS_THEME_CUSTOM_SCROLL_THUMB_DESC = "Заменяет цвет ползунка полосы прокрутки."
	L.SETTINGS_THEME_CUSTOM_ICON = "Оттенок значков"
	L.SETTINGS_THEME_CUSTOM_ICON_DESC = "Заменяет оттенок значков на оформленных кнопках."
	L.SETTINGS_THEME_RESET_CUSTOM = "Сбросить свою тему"
	L.SETTINGS_THEME_RESET_COLOR_TOOLTIP = "Щёлкните правой кнопкой, чтобы унаследовать этот цвет из тёмной темы."
	L.SETTINGS_THEME_BROKER_TOOLTIP_HEADER = "Подсказки брокера"
	L.SETTINGS_THEME_BROKER_TOOLTIP_BACKGROUND = "Цвет фона"
	L.SETTINGS_THEME_BROKER_TOOLTIP_BACKGROUND_DESC = "Заменяет цвет фона подсказок брокера друзей и гильдии в выбранной теме."
	L.SETTINGS_THEME_BROKER_TOOLTIP_OPACITY = "Прозрачность подсказки брокера"
	L.SETTINGS_THEME_BROKER_TOOLTIP_OPACITY_DESC = "Заменяет прозрачность фона подсказок брокера друзей и гильдии в выбранной теме."
	L.SETTINGS_THEME_BROKER_TOOLTIP_RESET = "Сбросить подсказки брокера"
	L.GUILD_CONTEXT_SECTION_SYSTEM = "Система"
	L.SETTINGS_TAB_GUILD = "Гильдия"
	L.SETTINGS_GUILD_DESC = "Настройте бета-вкладку состава гильдии. Она доступна только при включённых бета-функциях."
	L.SETTINGS_GUILD_ROSTER_HEADER = "Настройки состава"
	L.SETTINGS_ENABLE_GUILD_TAB_DESC = "Бета: показывает вкладку состава гильдии с поддерживаемыми действиями управления составом и гильдией."
	L.SETTINGS_GUILD_DEFAULT_FILTER = "Фильтр по умолчанию"
	L.SETTINGS_GUILD_DEFAULT_FILTER_DESC = "Начальный фильтр состояния для вкладки гильдии."
	L.SETTINGS_GUILD_DEFAULT_SORT = "Сортировка по умолчанию"
	L.SETTINGS_GUILD_DEFAULT_SORT_DESC = "Начальная сортировка для вкладки гильдии."
	L.SETTINGS_GUILD_SHOW_CLASS_ICONS = "Показывать значки классов"
	L.SETTINGS_GUILD_SHOW_CLASS_ICONS_DESC = "Показывает значки классов в строках состава гильдии."
	L.SETTINGS_GUILD_USE_NICKNAMES = "Использовать псевдонимы гильдии BFL"
	L.SETTINGS_GUILD_USE_NICKNAMES_DESC = "Использует локальные псевдонимы участников гильдии BetterFriendlist на вкладке гильдии."
	L.GUILD_SEARCH_PLACEHOLDER = "Поиск по гильдии..."
	L.GUILD_HEADER_FILTER_TOOLTIP = "Фильтр гильдии: %s"
	L.GUILD_HEADER_SORT_TOOLTIP = "Сортировка гильдии: %s"
	L.GUILD_ACTIONS_MENU = "Действия гильдии"
	L.GUILD_ACTION_INVITE_TO_GUILD = "Пригласить в гильдию"
	L.GUILD_ACTION_EDIT_MOTD = "Изменить сообщение дня"
	L.GUILD_ACTION_LEAVE_GUILD = "Покинуть гильдию"
	L.GUILD_ACTION_DISBAND_GUILD = "Распустить гильдию"
	L.GUILD_ACTION_SET_LEADER = "Назначить главу гильдии"
	L.GUILD_INVITE_PLAYER_TITLE = "Пригласить игрока в гильдию"
	L.GUILD_EDIT_MOTD_TITLE = "Изменить сообщение дня гильдии"
	L.GUILD_REMOVE_CONFIRM = "Исключить %s из гильдии?"
	L.GUILD_SET_RANK_CONFIRM = "Назначить %s ранг %s?"
	L.GUILD_ACTION_RESTRICTED = "Это действие сейчас недоступно."
	L.GUILD_ACTION_NO_PERMISSION = "У вас нет разрешения на это действие."

	-- LibSettingsDesigner Settings Center
	L.SETTINGS_CENTER_TITLE = "Настройки BetterFriendlist"
	L.SETTINGS_CENTER_DASHBOARD = "Главная"
	L.SETTINGS_CENTER_NEW = "Новое"
	L.SETTINGS_CENTER_DASHBOARD_DESC = "Настройки по задачам: друзья, внешний вид, социальные инструменты, плагины брокера, синхронизация и конфиденциальность."
	L.configCenterLockWindow = "Закрепить окно"
	L.configCenterUnlockWindow = "Открепить окно"
	L.configCenterLockWindowDesc = "Запрещает перемещать окно настроек касанием или перетаскиванием мышью."
	L.SETTINGS_CENTER_CATEGORY_FRIENDS = "Список друзей"
	L.SETTINGS_CENTER_CATEGORY_APPEARANCE = "Внешний вид"
	L.SETTINGS_CENTER_CATEGORY_GROUPS_SORTING = "Группы и сортировка"
	L.SETTINGS_CENTER_CATEGORY_SOCIAL = "Социальные инструменты"
	L.SETTINGS_CENTER_CATEGORY_BROKER_SYNC = "Брокер и синхронизация"
	L.SETTINGS_CENTER_CATEGORY_PRIVACY = "Конфиденциальность"
	L.SETTINGS_CENTER_CATEGORY_HELP = "Справка"
	L.SETTINGS_CENTER_PAGE_FRIENDS_DISPLAY = "Отображение"
	L.SETTINGS_CENTER_PAGE_FRIENDS_FORMATTING = "Имя и информация"
	L.SETTINGS_CENTER_PAGE_FRIENDS_BEHAVIOR = "Поведение"
	L.SETTINGS_CENTER_PAGE_APPEARANCE_THEME = "Тема"
	L.SETTINGS_CENTER_PAGE_APPEARANCE_FONTS = "Шрифты"
	L.SETTINGS_CENTER_PAGE_APPEARANCE_FRAME = "Окно"
	L.SETTINGS_CENTER_PAGE_GROUPS_BUILTINS = "Встроенные группы"
	L.SETTINGS_CENTER_PAGE_GROUPS_HEADERS = "Заголовки"
	L.SETTINGS_CENTER_PAGE_GROUPS_ORDER = "Порядок групп"
	L.SETTINGS_CENTER_PAGE_SOCIAL_WHO = "Кто"
	L.SETTINGS_CENTER_PAGE_SOCIAL_RAID = "Рейд"
	L.SETTINGS_CENTER_PAGE_SOCIAL_GUILD = "Гильдия"
	L.SETTINGS_CENTER_PAGE_BROKER_FRIENDS = "Брокер друзей"
	L.SETTINGS_CENTER_PAGE_BROKER_GUILD = "Брокер гильдии"
	L.SETTINGS_CENTER_PAGE_SYNC = "Синхронизация"
	L.SETTINGS_CENTER_PAGE_PRIVACY_STREAMER = "Режим стримера"
	L.SETTINGS_CENTER_PAGE_PRIVACY_WHISPER = "Шёпот"
	L.SETTINGS_CENTER_PAGE_ADVANCED_TOOLS = "Инструменты"
	L.SETTINGS_CENTER_PAGE_ADVANCED_BETA = "Бета-функции"
	L.SETTINGS_CENTER_PAGE_HELP = "Справка"
	L.SETTINGS_CENTER_GROUP_ROWS = "Строки"
	L.SETTINGS_SHOW_GAME_ICON = "Показывать значок игры"
	L.SETTINGS_SHOW_GAME_ICON_DESC = "Показывает значки игр рядом с друзьями Battle.net."
	L.SETTINGS_COLOR_LEVEL_BY_DIFFICULTY = "Цвет уровней по сложности"
	L.SETTINGS_COLOR_LEVEL_BY_DIFFICULTY_DESC = "Окрашивает уровень в зависимости от сложности относительно вашего персонажа."
	L.SETTINGS_SHOW_NOTE_ICON = "Показывать значок заметки"
	L.SETTINGS_SHOW_NOTE_ICON_DESC = "Показывает значок, если у друга есть заметка."
	L.SETTINGS_SIMPLE_MODE_SHOW_SEARCH = "Показывать поиск в простом режиме"
	L.SETTINGS_SIMPLE_MODE_SHOW_SEARCH_DESC = "Оставляет поле поиска видимым в простом режиме."
	...
	L.SETTINGS_QUICK_FILTER = "Быстрый фильтр"
	L.SETTINGS_QUICK_FILTER_DESC = "Выберите фильтр списка друзей по умолчанию."
	L.SETTINGS_PRIMARY_SORT = "Основная сортировка"
	L.SETTINGS_PRIMARY_SORT_DESC = "Выберите основной способ сортировки списка друзей."
	L.SETTINGS_SECONDARY_SORT = "Дополнительная сортировка"
	L.SETTINGS_SECONDARY_SORT_DESC = "Выберите дополнительную сортировку внутри групп основной сортировки."
	L.SETTINGS_CENTER_GROUP_CLICKS = "Действия мыши"
	L.SETTINGS_CENTER_OPEN = "Открыть"
	L.SETTINGS_RESET_THEME = "Сбросить тему"
	L.SETTINGS_RESET_THEME_DESC = "Восстанавливает стандартные визуальные параметры этой темы."
	L.SETTINGS_THEME_CUSTOM_COLORS = "Свои цвета"
	L.SETTINGS_THEME_CUSTOM_COLORS_DESC = "Задайте цвета палитры пользовательской темы."
	L.SETTINGS_RESET_CUSTOM_COLORS = "Сбросить свои цвета"
	L.SETTINGS_RESET_CUSTOM_COLORS_DESC = "Восстанавливает стандартную палитру пользовательской темы."
	L.SETTINGS_CUSTOM_COLOR_backgroundColor = "Фон"
	L.SETTINGS_CUSTOM_COLOR_surfaceColor = "Панель"
	L.SETTINGS_CUSTOM_COLOR_insetColor = "Внутренняя панель"
	L.SETTINGS_CUSTOM_COLOR_controlColor = "Элементы управления"
	L.SETTINGS_CUSTOM_COLOR_borderColor = "Границы"
	L.SETTINGS_CUSTOM_COLOR_accentColor = "Акцент"
	L.SETTINGS_CUSTOM_COLOR_textColor = "Текст"
	L.SETTINGS_CUSTOM_COLOR_disabledTextColor = "Неактивный текст"
	L.SETTINGS_CUSTOM_COLOR_hoverColor = "Наведение"
	L.SETTINGS_CUSTOM_COLOR_selectedColor = "Выбранное"
	L.SETTINGS_CUSTOM_COLOR_scrollThumbColor = "Ползунок прокрутки"
	L.SETTINGS_CUSTOM_COLOR_iconColor = "Значки"
	L.SETTINGS_RAID_SHORTCUT_MODIFIER = "Модификатор"
	L.SETTINGS_RAID_SHORTCUT_BUTTON = "Кнопка мыши"
	L.SETTINGS_RAID_SHORTCUT_MOD_NONE = "Без модификатора"
	L.SETTINGS_RAID_SHORTCUT_BUTTON_LEFT = "Левая кнопка"
	L.SETTINGS_RAID_SHORTCUT_BUTTON_RIGHT = "Правая кнопка"
	L.SETTINGS_RAID_SHORTCUT_BUTTON_MIDDLE = "Средняя кнопка"
	L.SETTINGS_RAID_SHORTCUT_BUTTON_4 = "Кнопка 4"
	L.SETTINGS_RAID_SHORTCUT_BUTTON_5 = "Кнопка 5"
	L.SETTINGS_CENTER_GROUP_ORDER_DESC = "Управляет пользовательским порядком групп и цветами заголовков."
	L.SETTINGS_CENTER_GROUP_ORDER_EMPTY = "Нет доступных групп."
	L.SETTINGS_CENTER_GROUP_COLOR_SWATCH_DESC = "Нажмите, чтобы изменить этот цвет."
	L.SETTINGS_COLORS = "Цвета"
	L.SETTINGS_GROUP_COLOR_DESC = "Настройте цвета заголовков групп."
	L.SETTINGS_GROUP_COUNT_COLOR_DESC = "Настройте цвета счётчиков групп."
	L.SETTINGS_GROUP_ARROW_COLOR_DESC = "Настройте цвета стрелок групп."
	L.SETTINGS_CENTER_COMPLEX_EDITORS = "Редакторы"
	L.SETTINGS_CENTER_PAGE_QUICKFILTER_EDITOR = "Редактор быстрых фильтров и сортировок"
	L.SETTINGS_CENTER_QUICKFILTER_EDITOR_DESC = "Создавайте, упорядочивайте, просматривайте и изменяйте пользовательские быстрые фильтры и сортировки."
	L.SETTINGS_CENTER_PAGE_QUICKFILTER_ENTRY = "Параметры фильтра или сортировки"
	L.SETTINGS_CENTER_PAGE_QUICKFILTER_ENTRY_DESC = "Измените выбранный быстрый фильтр или сортировку с помощью полноразмерных элементов управления."
	L.SETTINGS_CENTER_BACK_TO_QUICKFILTER_MANAGER = "Назад к фильтрам и сортировкам"
	L.SETTINGS_CENTER_QUICKFILTER_MANAGER_HINT = "Вернитесь к списку, чтобы выбрать другой элемент."
	L.SETTINGS_CENTER_OPEN_EDITOR = "Открыть редактор"
	L.BROKER_SETTINGS_SHOW_BNET_ICON = "Показывать значок Battle.net"
	L.BROKER_SETTINGS_TOOLTIP_HEADER = "Подсказка"
	L.BROKER_SETTINGS_USE_CUSTOM_FONT_NON_LATIN = "Свой шрифт для нелатинского текста"
	L.BROKER_SETTINGS_COLUMN_VISIBILITY = "Видимые столбцы"
	L.BROKER_SETTINGS_COLUMN_ORDER = "Порядок столбцов"
	L.SETTINGS_CENTER_BROKER_COLUMNS_DESC = "Выберите столбцы в подсказке брокера друзей."
	L.SETTINGS_CENTER_BROKER_COLUMN_ORDER_DESC = "Перемещайте столбцы, чтобы изменить порядок их отображения."
	L.SETTINGS_CENTER_BROKER_COLUMN_ORDER_VISIBILITY_DESC = "Перемещайте столбцы для изменения порядка и используйте флажки, чтобы показывать или скрывать их."
	L.SETTINGS_CENTER_BROKER_COLUMN_COLORS_DESC = "Задайте цвета текста столбцов. Кнопка сброса восстанавливает стандартный цвет."
	L.GUILD_BROKER_SETTINGS_TOOLTIP_MODE = "Режим подсказки"
	L.GUILD_BROKER_SETTINGS_COLUMN_VISIBILITY = "Видимые столбцы"
	L.GUILD_BROKER_SETTINGS_COLUMN_ORDER = "Порядок столбцов"
	L.GUILD_BROKER_SETTINGS_NICKNAME_CLASS_COLOR = "Цвет псевдонима по классу"
	L.SETTINGS_CENTER_GUILD_BROKER_COLUMNS_DESC = "Выберите столбцы в подсказке брокера гильдии."
	L.SETTINGS_CENTER_PAGE_SYNC_DATABASE = "Синхронизированная база друзей"
	L.SETTINGS_CENTER_GLOBAL_SYNC_DATABASE_DESC = "Просматривайте, восстанавливайте, удаляйте и изменяйте синхронизированные записи друзей."
	L.SETTINGS_CENTER_OPEN_DATABASE = "Открыть базу данных"
	L.SETTINGS_CENTER_HELP_DESC = "Центр настроек BetterFriendlist"
	L.SETTINGS_CENTER_HELP_SLASH = "Команда /bfl settings открывает этот центр настроек."
	L.SETTINGS_CENTER_HELP_SLASH_COMMANDS = "Команды чата"
	L.SETTINGS_CENTER_HELP_COMMAND_SETTINGS = "Открыть центр настроек."
	L.SETTINGS_CENTER_HELP_COMMAND_CHANGELOG = "Открыть отдельное окно журнала изменений."
	L.SETTINGS_CENTER_HELP_COMMAND_DISCORD = "Показать ссылку-приглашение Discord."
	L.SETTINGS_CENTER_HELP_SUPPORT = "Поддержка"
	L.SETTINGS_CENTER_HELP_SUPPORT_TEXT = "В отчёте об ошибке укажите версии BetterFriendlist и WoW, активный клиент и шаги воспроизведения."
	L.SETTINGS_CENTER_CUSTOMIZED = "Настроено"
	L.SETTINGS_CENTER_CHANGED = "Изменено"
	L.SETTINGS_CENTER_VERSION = "Версия"
	L.SETTINGS_CENTER_TOTAL_SETTINGS = "Настройки"
	L.SETTINGS_CENTER_ENABLED_FEATURES = "Включено"
	L.SETTINGS_CENTER_CARD_FRIENDS_DESC = "Отображение, форматирование и поведение."
	L.SETTINGS_CENTER_CARD_APPEARANCE_DESC = "Тема, шрифты и расположение окна."
	L.SETTINGS_CENTER_CARD_GROUPS_DESC = "Встроенные группы, заголовки, порядок и фильтры."
	L.SETTINGS_CENTER_CARD_BROKER_DESC = "Плагины Data Broker и инструменты синхронизации."
	L.SETTINGS_CENTER_CARD_HELP_DESC = "Команды чата, сведения для поддержки и ссылки."
	L.SETTINGS_CENTER_CARD_CHANGELOG_DESC = "Разворачиваемые примечания к выпускам в центре настроек."
	L.SETTINGS_CENTER_CARD_SUPPORT_DESC = "Сообщество, отчёты об ошибках и ссылки поддержки."
	L.SETTINGS_CENTER_PAGE_CHANGELOG = "Журнал изменений"
	L.SETTINGS_CENTER_PAGE_CHANGELOG_DESC = "Недавние примечания к выпускам BetterFriendlist."
	L.SETTINGS_CENTER_CHANGELOG_RELEASE_NOTES = "Примечания к выпуску"
	L.SETTINGS_CENTER_CHANGELOG_DRAFT = "Черновик"
	L.SETTINGS_CENTER_CHANGELOG_EMPTY = "Примечания к выпускам отсутствуют."
	L.SETTINGS_CENTER_PAGE_SUPPORT_LINKS = "Ссылки поддержки"
	L.SETTINGS_CENTER_PAGE_SUPPORT_LINKS_DESC = "Discord, задачи GitHub и Ko-fi."
	L.SETTINGS_CENTER_SUPPORT_INTRO = "Используйте эти ссылки для поддержки, отчётов об ошибках, предложений функций или помощи разработке."
	L.SETTINGS_CENTER_SUPPORT_COPY_LINKS = "Копировать ссылки"
	L.SETTINGS_CENTER_SUPPORT_DISCORD = "Discord"
	L.SETTINGS_CENTER_SUPPORT_GITHUB = "Задачи GitHub"
	L.SETTINGS_CENTER_SUPPORT_KOFI = "Ko-fi"
	L.SETTINGS_CENTER_RELOAD_REQUIRED = "Для этого изменения требуется перезагрузить интерфейс.\\n\\nПерезагрузить сейчас?"
	L.SETTINGS_FRIEND_CLICK_WHISPER = "Нажмите для шёпота"
	L.SETTINGS_FRIEND_CLICK_WHISPER_DESC = "Позволяет начать шёпот щелчком по строке друга."
	L.SETTINGS_FRIEND_CLICK_WHISPER_MODE = "Запуск шёпота"
	L.SETTINGS_FRIEND_CLICK_WHISPER_MODE_DESC = "Выберите, начинать шёпот одинарным или двойным щелчком."
	L.SETTINGS_CLICK_SINGLE = "Одинарный щелчок"
	L.SETTINGS_CLICK_DOUBLE = "Двойной щелчок"
	L.SETTINGS_ENABLE_IN_GAME_GROUP = "Включить группу «В игре»"
	L.SETTINGS_ENABLE_IN_GAME_GROUP_DESC = "Показывает динамическую группу друзей, которые сейчас в игре."
	L.SETTINGS_IN_GAME_GROUP_MODE = "Режим группы «В игре»"
	L.SETTINGS_IN_GAME_GROUP_SAME_GAME = "Та же версия WoW"
	L.SETTINGS_IN_GAME_GROUP_ANY_GAME = "Любая игра Battle.net"
	L.SETTINGS_ENABLE_RECENTLY_ADDED_GROUP = "Включить группу «Недавно добавленные»"
	L.SETTINGS_ENABLE_RECENTLY_ADDED_GROUP_DESC = "Отслеживает недавно найденных друзей во временной группе."
	L.SETTINGS_RECENTLY_ADDED_MINUTES = "Минуты"
	L.SETTINGS_RECENTLY_ADDED_HOURS = "Часы"
	L.SETTINGS_RECENTLY_ADDED_DAYS = "Дни"
	L.SETTINGS_WHO_SHOW_CLASS_ICONS = "Показывать значки классов"
	L.SETTINGS_WHO_CLASS_COLOR_NAMES = "Цвет имён по классу"
	L.SETTINGS_WHO_LEVEL_COLORS = "Цвет уровней"
	L.SETTINGS_WHO_ZEBRA_STRIPES = "Чередующиеся строки"
	L.SETTINGS_WHO_ZEBRA_STRIPE_STRENGTH = "Интенсивность чередования строк"
	L.SETTINGS_WHO_DOUBLE_CLICK_ACTION = "Действие двойного щелчка"
	L.SETTINGS_STREAMER_HEADER_TEXT = "Текст заголовка"
	L.SETTINGS_SYNC_GROUPS_HEADER = "Синхронизация заметок групп"
	L.SETTINGS_DEBUG_PRINT = "Отладочные сообщения"
	L.SETTINGS_DEBUG_PRINT_DESC = "Включает подробные отладочные сообщения BetterFriendlist."
	L.BROKER_TOOLTIP_BASIC = "Обычный"
	L.BROKER_TOOLTIP_ADVANCED = "Расширенный"
	L.BROKER_CLICK_TOGGLE = "Показать или скрыть друзей"
	L.BROKER_CLICK_FRIENDS = "Открыть список друзей"
	L.BROKER_CLICK_SETTINGS = "Открыть настройки"
	L.STATUS_APPEAR_OFFLINE = "Не в сети"
	L.MENU_SET_TITLE_FRIEND_NAME = "Изменить имя избранного друга"
	L.TITLE_FRIEND_CUSTOM_NAME_PROMPT = "Введите своё имя для этого избранного друга."
	L.SETTINGS_FONT = "Шрифт:"
	L.SETTINGS_NAME_FORMAT_CUSTOM = "Пользовательская"
	L.SETTINGS_INFO_FORMAT_CUSTOM = "Пользовательская"
	L.WIZARD_BACKUP_VIEWER = "Просмотр резервной копии"
	L.GUILD_NICKNAME = "Псевдоним"
	L.SETTINGS_FONT_FRIEND_NAME_TITLE = "Текст имени друга"
	L.SETTINGS_FONT_FRIEND_INFO_TITLE = "Текст информации о друге"
	L.SETTINGS_FONT_TOOLTIP = "Выберите шрифт."
	L.SETTINGS_FONT_SIZE_TOOLTIP = "Задайте размер шрифта."
	L.SETTINGS_FONT_SHADOW_TOOLTIP = "Добавляет тень позади текста."
	L.SETTINGS_FONT_COLOR_TOOLTIP = "Задайте цвет текста."
	L.SETTINGS_NAME_FORMAT_DEFAULT = "По умолчанию"
	L.SETTINGS_NAME_FORMAT_NICKNAME = "Псевдоним"
	L.SETTINGS_NAME_FORMAT_BATTLETAG = "BattleTag"
	L.SETTINGS_NAME_FORMAT_NAME_NICKNAME = "Имя (псевдоним)"
	L.SETTINGS_NAME_FORMAT_NAME_BATTLETAG = "Имя (BattleTag)"
	L.SETTINGS_NAME_FORMAT_NAME_NOTE = "Имя (заметка)"
	L.SETTINGS_INFO_FORMAT_DEFAULT = "По умолчанию"
	L.SETTINGS_INFO_FORMAT_DISABLED = "Отключено"
	L.SETTINGS_INFO_FORMAT_GAME = "Игра"
	L.SETTINGS_INFO_FORMAT_CLASS_ZONE = "Класс и зона"
	L.SETTINGS_INFO_FORMAT_LEVEL_CLASS_ZONE = "Уровень, класс и зона"
	L.SETTINGS_TAB_STREAMER = "Режим стримера"
	L.SETTINGS_FRIENDS_UI_STYLE_HEADER = "Интерфейс списка друзей"
	L.SETTINGS_FRIENDS_UI_STYLE = "Стиль интерфейса"
	L.SETTINGS_FRIENDS_UI_STYLE_DESC = "Выберите оформление Retail 12.1 или прежнее оформление BetterFriendlist. Современный стиль переключается на классический только тогда, когда в клиенте отсутствует API социального интерфейса."
	L.SETTINGS_FRIENDS_UI_STYLE_MODERN = "Современный (Retail 12.1)"
	L.SETTINGS_FRIENDS_UI_STYLE_LEGACY = "Классический"
	L.SETTINGS_FRIENDS_UI_MODERN_UNAVAILABLE = "В этом клиенте отсутствует API социального интерфейса Blizzard. Современный стиль недоступен."
	L.CORE_FORCE_MODERN_ENABLED = "Принудительный современный список друзей включён. Отсутствие API социального интерфейса будет игнорироваться."
	L.CORE_FORCE_MODERN_DISABLED = "Принудительный современный список друзей отключён. BetterFriendlist снова будет автоматически определять наличие API."
	L.CORE_FORCE_MODERN_STATUS = "Принудительный современный стиль: %s | Социальный интерфейс Blizzard: %s | Действующий стиль: %s"
	L.CORE_FORCE_MODERN_USAGE = "Использование: /bfl forcemodern on|off|status"
	L.CORE_FORCE_MODERN_RETAIL_ONLY = "Принудительный современный список друзей доступен только в Retail."
	L.CORE_HELP_CMD_FORCE_MODERN = "  |cffffffff/bfl forcemodern on|off|status|r - Переопределить обнаружение API социального интерфейса"
	L.ONBOARDING_THEME_BLIZZARD_DESC = "Сохраните знакомые текстуры и цвета Blizzard вместе со всеми возможностями BetterFriendlist."
	L.ONBOARDING_THEME_DARK_DESC = "Сосредоточенный тёмный интерфейс со спокойным контрастом и акцентами BetterFriendlist."
	L.ONBOARDING_THEME_CUSTOM_DESC = "Используйте личную цветовую палитру и настройки темы BetterFriendlist."
	L.ONBOARDING_THEME_ELVUI_DESC = "Согласуйте оформление BetterFriendlist с ElvUI. Для этой темы требуется перезагрузка интерфейса."
	L.ONBOARDING_THEME_ELLESMEREUI_DESC = "Согласуйте оформление BetterFriendlist с EllesmereUI. Для этой темы требуется перезагрузка интерфейса."
	L.ONBOARDING_THEME_GENERIC_DESC = "Предпросмотр темы «%s» в BetterFriendlist."
	L.ONBOARDING_RECOMMENDED = "Рекомендуется"
	L.ONBOARDING_STYLE_MODERN_DESC = "Оцените обновлённый список друзей Retail 12.1 с боковой навигацией, современными карточками и быстрым доступом ко всем социальным разделам."
	L.ONBOARDING_STYLE_LEGACY_DESC = "Сохраните привычный вид BetterFriendlist с проверенными вкладками и порядком работы."
	L.ONBOARDING_RELOAD_BADGE = "Требуется перезагрузка"
	L.ONBOARDING_BACK = "Назад"
	L.ONBOARDING_LATER = "Решить позже"
	L.ONBOARDING_COMBAT_WAIT = "Завершите бой, чтобы продолжить настройку."
	L.ONBOARDING_SUMMARY_STYLE = "Стиль интерфейса"
	L.ONBOARDING_SUMMARY_THEME = "Тема"
	L.ONBOARDING_CHANGE_LATER = "Все эти параметры можно изменить в любой момент в настройках BetterFriendlist."
	L.ONBOARDING_LAYOUT_TITLE = "Настройте список друзей"
	L.ONBOARDING_LAYOUT_DESC =
		"Выберите упрощённый вид окна и более плотные строки друзей. Оба параметра можно сочетать."
	L.ONBOARDING_RELOAD_NOTE = "После подтверждения вы сможете перезагрузить интерфейс и применить смену темы."
	L.ONBOARDING_STEP_FORMAT = "Шаг %d из %d"
	L.ONBOARDING_WELCOME_TITLE = "Добро пожаловать в новый BetterFriendlist"
	L.ONBOARDING_WELCOME_DESC = "В Retail 12.1 список друзей полностью преобразился. Выберите наиболее удобный для вас интерфейс."
	L.ONBOARDING_THEME_TITLE = "Настройте BetterFriendlist под себя"
	L.ONBOARDING_THEME_DESC = "Выберите визуальную тему. Доступные темы определяются автоматически, и большинство можно просмотреть сразу."
	L.ONBOARDING_SUMMARY_TITLE = "BetterFriendlist готов"
	L.ONBOARDING_SUMMARY_DESC =
		"Подтвердите стиль интерфейса, тему и параметры компоновки, чтобы завершить настройку."
	L.ONBOARDING_CONFIRM = "Использовать эти настройки"
	L.ONBOARDING_NEXT = "Далее"
	L.SETTINGS_CENTER_PAGE_FRIEND_TABS = "Вкладки друзей"
	L.SETTINGS_CENTER_PAGE_FRIEND_TABS_DESC = "Настраивает порядок и видимость боковых вкладок современного списка друзей."
	L.SETTINGS_FRIEND_TABS_ORDER = "Порядок и видимость вкладок"
	L.SETTINGS_FRIEND_TABS_ORDER_DESC = "Перетаскивайте вкладки в нужном порядке. Переключатель в каждой строке показывает или скрывает вкладку."
	L.SETTINGS_FRIEND_TABS_ORDER_EMPTY = "Нет доступных вкладок друзей."
	L.SETTINGS_FRIEND_TABS_CONDITIONAL = "Условная видимость"
	L.SETTINGS_FRIEND_TABS_VISIBILITY = "Видимость вкладки"
	L.SETTINGS_FRIEND_TABS_VISIBILITY_DESC = "Показывает или скрывает эту вкладку в современном списке друзей."
	L.SETTINGS_FRIEND_TABS_REQUESTS_POPULATED_ONLY = "Показывать запросы в друзья только при наличии"
	L.SETTINGS_FRIEND_TABS_REQUESTS_POPULATED_ONLY_DESC = "Скрывает вкладку запросов в друзья, когда нет ожидающих запросов."
	L.SETTINGS_FRIEND_TABS_QUICK_JOIN_POPULATED_ONLY = "Показывать быстрое присоединение только при наличии"
	L.SETTINGS_FRIEND_TABS_QUICK_JOIN_POPULATED_ONLY_DESC = "Скрывает вкладку быстрого присоединения, когда нет доступных групп."
	L.FRIENDS_UI_SECTION_FRIENDS = "Друзья"
	L.FRIENDS_UI_SECTION_RECENT_ALLIES = "Недавние союзники"
	L.FRIENDS_UI_SECTION_QUICK_JOIN = "Быстрое вступление"
	L.FRIENDS_UI_SECTION_REQUESTS = "Запросы в друзья"
	L.FRIENDS_UI_SECTION_RECRUIT_A_FRIEND = "Пригласи друга"
	L.FRIENDS_UI_SECTION_RAID = "Рейд"
	L.FRIENDS_UI_SECTION_GUILD = "Гильдия"
	L.FRIENDS_UI_SECTION_WHO = "Кто"
	L.FRIENDS_UI_SORT_TOOLTIP = "Основная и дополнительная сортировка"
	L.FRIENDS_UI_COPY_BATTLETAG = "Копировать BattleTag"
	L.FRIENDS_UI_RAID_STORY_DISABLED = "Недоступно во время сюжетного рейда."
	L.FRIENDS_UI_REQUEST_REAL_ID = "Запрос Real ID"
	L.FRIENDS_UI_REQUEST_BATTLETAG = "Запрос BattleTag"
	L.FRIENDS_UI_REQUEST_TITLE = "Запрос World of Warcraft"
	L.FRIENDS_UI_REQUEST_RECEIVED = "Получен %s назад"
	L.FRIENDS_UI_REQUESTS_EMPTY = "Нет ожидающих запросов в друзья"
	L.FRIENDS_UI_REAL_ID_WARNING = "Запросы Real ID показывают другому игроку ваше настоящее имя. Принимайте запросы только от знакомых людей."
	L.ALIGN_LEFT = "Слева"
