...
if GetLocale() == "ruRU" then
	...
	L.DIALOG_RESET_BTN2 = "Отмена"	L.DIALOG_UI_PANEL_RELOAD_TEXT = "Изменение настройки иерархии UI требует перезагрузки интерфейса.\n\nПерезагрузить сейчас?"
	...
	L.RAID_NOT_IN_RAID_DETAILS = "Вы не состоите в рейдовой группе."
