...
L.SETTINGS_SHOW_ILVL_COLUMN_DESC = "Show an item level column in the Guild tab list."
	...
	L.SETTINGS_THEME_ARTWORK_VISIBILITY = "Blizzard Artwork Visibility"
	L.SETTINGS_THEME_ARTWORK_VISIBILITY_DESC = "Controls how much original Blizzard artwork remains visible under the skin."
