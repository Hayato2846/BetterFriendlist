...
local L = BFL_LOCALE
	...
	L.SETTINGS_SIMPLE_MODE_DESC = "Отключает портрет игрока, скрывает параметры поиска/сортировки, расширяет фрейм и смещает вкладки для компактного макета."
...
L.DIALOG_UI_PANEL_RELOAD_TEXT = "Изменение настройки иерархии UI требует перезагрузки интерфейса.\n\nПерезагрузить сейчас?"
L.DIALOG_UI_PANEL_RELOAD_BTN1 = "Перезагрузить"
L.DIALOG_UI_PANEL_RELOAD_BTN2 = "Отмена"
L.MSG_RELOAD_REQUIRED = "Для корректного применения этого изменения в Classic требуется перезагрузка."
...
L.RAID_HELP_MULTISELECT_TEXT = "Удерживайте Ctrl и щелкните левой кнопкой, чтобы выбрать нескольких игроков.\nПосле выбора перетащите их в любую группу, чтобы переместить всех сразу."
L.RAID_HELP_MAINTANK_TITLE = "Главный танк"
L.RAID_HELP_MAINTANK_TEXT = "%s на игроке, чтобы назначить его главным танком.\nРядом с его именем появится значок танка."
L.RAID_HELP_MAINASSIST_TITLE = "Главный помощник"
L.RAID_HELP_MAINASSIST_TEXT = "%s на игроке, чтобы назначить его главным помощником.\nРядом с его именем появится значок помощника."
...
L.RAID_ERROR_READY_CHECK_PERMISSION = "Вы должны быть лидером рейда или помощником, чтобы начать проверку готовности."
L.RAID_ERROR_NO_SAVED_INSTANCES = "У вас нет сохраненных рейдовых подземелий."
L.RAID_ERROR_LOAD_RAID_INFO = "Ошибка: Не удалось загрузить окно информации о рейде."
...
L.SETTINGS_LOCK_WINDOW_DESC = "Блокирует окно для предотвращения случайного перемещения."
...
L.SETTINGS_SHOW_GROUP_DESC_FMT = "Переключить видимость группы %s в списке друзей"
...
L.SORT_NONE = "None"
	...
	L.SORT_SECONDARY_DESC = "Сортировать по этому, когда основные значения равны."
-- ========================================
-- MENUS & CONTEXT MENUS
-- ========================================
...
L.BROKER_COLUMN_GAME_DESC = "Показать игру или приложение, в котором находится друг"
...
L.SETTINGS_CLOSE_ON_GUILD_TAB_DESC = "Автоматически закрывать BetterFriendlist при нажатии на вкладку Гильдия"
...
L.SETTINGS_USE_UI_PANEL_SYSTEM_DESC = "Предотвращает открытие BetterFriendlist поверх других окон UI (Персонаж, Книга заклинаний и т.д.). Требуется /reload."
...
L.CLASSIC_GUILD_UI_WARNING_TEXT = "BetterFriendlist отключил классический интерфейс гильдии, так как только современный интерфейс гильдии Blizzard совместим с BetterFriendlist.\n\nВкладка Гильдия теперь открывает современный интерфейс гильдии Blizzard."
...
L.COMPAT_GAME_VERSION = "|cffffcc00Ver:|r"
	...
	L.SETTINGS_FAVORITE_ICON_STYLE_DESC = "Выберите, какой значок использовать для избранных."
	...
	L.STREAMER_MODE_DESC = "Варианты конфиденциальности для потоковой трансляции или записи."
	L.SETTINGS_ENABLE_STREAMER_MODE = "Показать кнопку режима потоковой трансляции"
	L.STREAMER_MODE_ENABLE_DESC = "Показывает кнопку в главном фрейме для переключения режима потоковой трансляции."
	L.STREAMER_MODE_HIDDEN_NAME = "Скрытый формат имени"
	L.STREAMER_MODE_HEADER_TEXT = "Пользовательский текст заголовка"
	L.STREAMER_MODE_HEADER_TEXT_DESC = "Текст для отображения в заголовке Battle.net при активном режиме потоковой трансляции (например, 'Stream Mode')."
	L.STREAMER_MODE_BUTTON_TOOLTIP = "Переключить режим потоковой трансляции"
	L.STREAMER_MODE_BUTTON_DESC = "Нажмите для включения/отключения режима конфиденциальности."
	L.SETTINGS_PRIVACY_OPTIONS = "Варианты конфиденциальности"
	L.SETTINGS_STREAMER_NAME_FORMAT = "Значения имен"
	L.SETTINGS_STREAMER_NAME_FORMAT_DESC = "Выберите, как отображаются имена в режиме потоковой трансляции."
	L.SETTINGS_STREAMER_NAME_FORMAT_BATTLENET = "Принудительное использование BattleTag"
	L.SETTINGS_STREAMER_NAME_FORMAT_NICKNAME = "Принудительное использование прозвища"
	...
	L.SETTINGS_STREAMER_USE_PURPLE_HEADER_DESC = "Измените фон заголовка Battle.net на фиолетовый Twitch при активном режиме потоковой трансляции."
	...
	L.SETTINGS_RAID_ENABLE_SHORTCUTS_DESC = "Включить или отключить все пользовательские сочетания клавиш мыши на экране рейда."
	...
	L.SETTINGS_RAID_DESC = "Настройте сочетания клавиш мыши для управления рейдом и группой."
	L.SETTINGS_RAID_MODIFIER_LABEL = "Мод:"
	L.SETTINGS_RAID_BUTTON_LABEL = "Кнп:"
	L.SETTINGS_RAID_WARNING = "Примечание: Сочетания клавиш - это защищенные действия (только вне боя)."
	...
	L.SETTINGS_GROUP_HEADER_ALIGN_DESC = "Установить выравнивание текста имени группы"
	...
	L.SETTINGS_SHOW_GROUP_ARROW_DESC = "Показать или скрыть значок стрелки для сворачивания групп"
	L.SETTINGS_GROUP_ARROW_ALIGN = "Выравнивание Стрелки Сворачивания"
	L.SETTINGS_GROUP_ARROW_ALIGN_DESC = "Установить выравнивание значка стрелки сворачивания/разворачивания"
	...
	L.SETTINGS_SHOW_WELCOME_MESSAGE_DESC = "Показывать сообщение загрузки аддона в чат при входе."
