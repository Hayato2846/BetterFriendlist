...
L.SETTINGS_SHOW_ILVL_COLUMN_DESC = "Показывает столбец уровня предметов в списке вкладки гильдии."
	...
	L.SETTINGS_FRIENDS_UI_STYLE_DESC = "Выберите оформление Retail 12.1 или прежнее оформление BetterFriendlist. Если социальный интерфейс Blizzard недоступен, современный стиль безопасно переключится на классический."
	L.SETTINGS_FRIENDS_UI_STYLE_MODERN = "Современный (Retail 12.1)"
	L.SETTINGS_FRIENDS_UI_STYLE_LEGACY = "Классический"
	L.SETTINGS_FRIENDS_UI_MODERN_UNAVAILABLE = "Система социального интерфейса Blizzard сейчас отключена. Современный стиль выбрать нельзя. Для тестирования используйте /bfl forcemodern on."
	L.CORE_FORCE_MODERN_ENABLED = "Принудительный современный список друзей включён. Состояние социального интерфейса Blizzard будет игнорироваться."
	L.CORE_FORCE_MODERN_DISABLED = "Принудительный современный список друзей отключён. BetterFriendlist будет учитывать состояние социального интерфейса Blizzard."
	...
	L.CORE_HELP_CMD_FORCE_MODERN = "  |cffffffff/bfl forcemodern on|off|status|r - Игнорировать состояние социального интерфейса для разработки"
