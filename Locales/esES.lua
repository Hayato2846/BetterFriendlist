...
BFL:RegisterLocale("esES", function()
	...
	L.SETTINGS_SIMPLE_MODE_DESC =
		"Desactiva el retrato del jugador, oculta opciones de búsqueda/ordenación, amplía el marco y desplaza las pestañas para una presentación compacta."
	...
	L.RAID_TOOLS_SPLIT_EVENS_ODDS = "Impares/Pares"
	L.RAID_TOOLS_SPLIT_EVENS_ODDS_DESC = "Divide la banda en grupos impares (1, 3, 5) y pares (2, 4, 6)"
	...
	L.SETTINGS_GROUP_HEADER_SETTINGS = "Ajustes Cabecera"
	...
	L.SETTINGS_GROUP_ORDER_HEADER = "Orden de Grupos"
	L.SETTINGS_GROUP_COUNT_COLOR = "Color Contador"
	L.SETTINGS_GROUP_ARROW_COLOR = "Color Flecha"
	...
	L.SORT_NONE = "Ninguno"
	L.SORT_PRIMARY_LABEL = "Orden Primario"
	...
	L.BROKER_HINT_SETTINGS = " Configuración â• "
	...
	L.GUILD_BROKER_SETTINGS_SHOW_ICON = "Mostrar icono"
	...
	L.DIALOG_RESET_LAYOUTS_TEXT =
		"Restablecer todos los tamaños y posiciones guardados para Modos de Edición?\n\nNo se puede deshacer!"
	...
	L.BROKER_SETTINGS_SHOW_HINTS = "Mostrar Pistas del Tooltip"
	L.BROKER_SETTINGS_SHOW_HINTS_TITLE = "Mostrar Pistas del Tooltip"
	L.BROKER_SETTINGS_SHOW_HINTS_TOOLTIP = "Muestra las pistas de acción en la parte inferior del tooltip del broker"
	...
	L.CORE_DEBUG_UIPANEL_YES = "|cffffcc00En UIPanelWindows:|r |cff00ff00Sé|r"
	...
	L.PERF_FPS_60 = "  â✓ <16.6ms = 60 FPS"
	L.PERF_FPS_30 = "  â✓ <33.3ms = 30 FPS"
	L.PERF_WARNING = "  â✗ >50ms = Aviso Rendimiento"
	...
	L.SETTINGS_FONT_OUTLINE = "Contorno Fuente"
	L.SETTINGS_FONT_SHADOW = "Sombra Fuente"
	...
	L.SETTINGS_RAID_ENABLE_SHORTCUTS_DESC =
		"Habilita o desactiva todos los atajos personalizados del ratón en el Marco de Banda."
	L.SETTINGS_RAID_SHORTCUTS_TITLE = "Raid Shortcuts"
	L.SETTINGS_RAID_ACTION_MASS_MOVE = "Movimiento Masivo"
	...
	L.WHO_SETTINGS_CLASS_ICONS = "Mostrar iconos de clase"
	L.WHO_SETTINGS_CLASS_ICONS_DESC = "Muestra iconos de clase junto a los nombres de jugadores."
	...
	L.SETTINGS_GROUP_FONT_HEADER = "Fuente del Encabezado del Grupo"
	L.SETTINGS_GROUP_COLOR_HEADER = "Colores del Encabezado del Grupo"
	L.TOOLTIP_RIGHT_CLICK_INHERIT = "Clic derecho para heredar del Grupo"
	L.SETTINGS_INHERIT_TOOLTIP = "(Heredado del Grupo)"
	...
	L.WIZARD_HEADER_DESC =
		"Elimina los sufijos de FriendGroups de las notas de amigos. Haz una copia de seguridad primero, luego revisa y aplica los cambios."
	L.WIZARD_COL_ACCOUNT = "Nombre de Cuenta"
	L.WIZARD_COL_BATTLETAG = "BattleTag"
	L.WIZARD_COL_NOTE = "Nota Actual"
	L.WIZARD_COL_CLEANED = "Nota Limpia"
	...
	L.WIZARD_VIEW_BACKUP_BTN = "Ver copia"
	L.WIZARD_VIEW_BACKUP_TOOLTIP =
		"Abre el visor de copias de seguridad para ver todas las notas guardadas y compararlas con las actuales."
	L.WIZARD_BACKUP_VIEWER_TITLE = "Visor de copia de notas"
	L.WIZARD_BACKUP_VIEWER_DESC =
		"Visualiza las notas de amigos guardadas y comparalas con las notas actuales. Puedes restaurar las notas originales si es necesario."
	L.WIZARD_COL_BACKED_UP = "Nota guardada"
	L.WIZARD_COL_CURRENT = "Nota actual"
	L.WIZARD_RESTORE_BTN = "Restaurar copia"
	L.WIZARD_RESTORE_TOOLTIP =
		"Restaura las notas originales desde la copia de seguridad. Solo se actualizaran las notas que difieran de la copia."
	L.WIZARD_RESTORE_CONFIRM =
		"Restaurar todas las notas desde la copia de seguridad?\n\n|cffff8800Esto sobrescribira las notas actuales con las versiones guardadas.|r"
