...
if GetLocale() == "koKR" then
	...
	-- NOTIFICATIONS TAB
	-- ========================================
	L.SETTINGS_NOTIFICATIONS_TITLE = "ì•Œë¦¼"
	L.SETTINGS_NOTIFICATIONS_DESC = "ì¹œêµ¬ ë¡œê·¸ì¸/ë¡œê·¸ì•„ì›ƒ ì•Œë¦¼ êµ¬ì„±"
	L.SETTINGS_NOTIFICATIONS_DISPLAY_HEADER = "ì•Œë¦¼ í‘œì‹œ"
	L.SETTINGS_NOTIFICATIONS_DISPLAY_MODE = "í‘œì‹œ ëª¨ë“œ"
	L.SETTINGS_NOTIFICATIONS_MODE_TOAST = "í† ìŠ¤íŠ¸ ì•Œë¦¼"
	L.SETTINGS_NOTIFICATIONS_MODE_CHAT = "ì±„íŒ… ë©”ì‹œì§€ë§Œ"
	L.SETTINGS_NOTIFICATIONS_MODE_DISABLED = "ë¹„í™œì„±í™”ë¨"
	L.SETTINGS_NOTIFICATIONS_MODE_DESC = "|cffffcc00í† ìŠ¤íŠ¸ ì•Œë¦¼:|r ì¹œêµ¬ê°€ ì˜¨ë¼ì¸ ìƒíƒœê°€ ë˜ë©´ ê°„ë‹¨í•œ ì•Œë¦¼ì„ í‘œì‹œí•©ë‹ˆë‹¤\n|cffffcc00ì±„íŒ… ë©”ì‹œì§€ë§Œ:|r íŒì—… ì—†ì´ ì±„íŒ… ë©”ì‹œì§€ë§Œ í‘œì‹œí•©ë‹ˆë‹¤\n|cffffcc00ë¹„í™œì„±í™”ë¨:|r ì•Œë¦¼ ì—†ìŒ"
	L.SETTINGS_NOTIFICATIONS_TEST_BUTTON = "ì•Œë¦¼ í…ŒìŠ¤íŠ¸"
	...
	L.SETTINGS_NOTIFICATIONS_SOUND_HEADER = "ì‚¬ìš´ë“œ ì„¤ì •"
	L.SETTINGS_NOTIFY_SOUND_HEADER = "ì‚¬ìš´ë“œ ì„¤ì •"
	L.SETTINGS_NOTIFY_SOUND = "ì•Œë¦¼ ì†Œë¦¬ ìž¬ìƒ"
	L.SETTINGS_NOTIFY_DND_MODE = "ë°©í•´ ê¸ˆì§€ ëª¨ë“œ"
	L.SETTINGS_NOTIFY_DND = "ë°©í•´ ê¸ˆì§€ (ì§€ì •ëœ ì†Œë¦¬ ë„ê¸°)"
	L.SETTINGS_NOTIFICATIONS_SOUND_ENABLE = "ì•Œë¦¼ê³¼ í•¨ê»˜ ì‚¬ìš´ë“œ ìž¬ìƒ"
	L.SETTINGS_NOTIFY_SOUND_ENABLE = "Play Sound"
	L.SETTINGS_NOTIFICATIONS_SOUND_ENABLED = "ì•Œë¦¼ ì‚¬ìš´ë“œ |cff00ff00í™œì„±í™”ë¨|r"
	L.SETTINGS_NOTIFY_SOUND_ENABLED = "Sounds |cff00ff00ON|r"
	L.SETTINGS_NOTIFICATIONS_SOUND_DISABLED = "ì•Œë¦¼ ì‚¬ìš´ë“œ |cffff0000ë¹„í™œì„±í™”ë¨|r"
	...
	L.SETTINGS_NOTIFICATIONS_COMING_SOON = "ê³µê°œ ì˜ˆì •"
	L.SETTINGS_NOTIFICATIONS_FUTURE_FEATURES = "â€¢ ì¹œêµ¬ë³„ ì•Œë¦¼ ê·œì¹™\nâ€¢ ê·¸ë£¹ íŠ¸ë¦¬ê±° (ê·¸ë£¹ Yì˜ Xëª… ì¹œêµ¬ ì˜¨ë¼ì¸)\nâ€¢ ì¡°ìš©í•œ ì‹œê°„ (ì „íˆ¬, ì¸ìŠ¤í„´ìŠ¤, ì¼ì •)\nâ€¢ ì‚¬ìš©ìž ì§€ì • ì•Œë¦¼ ë©”ì‹œì§€\nâ€¢ ì˜¤í”„ë¼ì¸ ì•Œë¦¼"
	L.SETTINGS_NOTIFICATIONS_QUIET_HOURS = "|cffffcc00ìžë™ ì¡°ìš©í•œ ì‹œê°„:|r\nâ€¢ ì „íˆ¬ ì¤‘ (ë°©í•´ ì—†ìŒ)\nâ€¢ í–¥í›„: ì¸ìŠ¤í„´ìŠ¤ ê°ì§€, ìˆ˜ë™ DND, ì˜ˆì•½ëœ ì‹œê°„"
	
	-- ========================================
	-- NOTIFICATION MESSAGES
	-- ========================================
	L.NOTIFICATION_MODE_CHANGED = "ì•Œë¦¼ ëª¨ë“œê°€ %s(ìœ¼)ë¡œ ì„¤ì •ë˜ì—ˆìŠµë‹ˆë‹¤"
	L.NOTIFICATION_TEST_MESSAGE = "í…ŒìŠ¤íŠ¸ ì•Œë¦¼ìž…ë‹ˆë‹¤"
	L.NOTIFICATION_FRIEND_ONLINE = "%së‹˜ì´ ì˜¨ë¼ì¸ ìƒíƒœìž…ë‹ˆë‹¤"
	L.NOTIFICATION_FRIEND_PLAYING = "%së‹˜ì´ ì˜¨ë¼ì¸ ìƒíƒœìž…ë‹ˆë‹¤ [%s í”Œë ˆì´ ì¤‘]"
	L.NOTIFICATION_SYSTEM_UNAVAILABLE = "ì•Œë¦¼ ì‹œìŠ¤í…œì„ ì‚¬ìš©í•  ìˆ˜ ì—†ìŠµë‹ˆë‹¤"
	L.NOTIFICATION_BETA_REQUIRED = "ì•Œë¦¼ì„ ì‚¬ìš©í•˜ë ¤ë©´ ë² íƒ€ ê¸°ëŠ¥ì´ í™œì„±í™”ë˜ì–´ì•¼ í•©ë‹ˆë‹¤"
	L.NOTIFICATION_BETA_ENABLE_HINT = "â†’ ì„¤ì • > ê³ ê¸‰ > ë² íƒ€ ê¸°ëŠ¥ì—ì„œ í™œì„±í™”í•˜ì„¸ìš”"
	...
	-- Notifications
	L.NOTIFICATION_GROUP_ALERT = "ê·¸ë£¹ ì•Œë¦¼"
	L.NOTIFICATION_GROUP_ALERT_MSG = "%d friends from '%s' online"
	L.NOTIFICATION_RECONNECTED = "ë‹˜ì´ ìž¬ì ‘ì†í–ˆìŠµë‹ˆë‹¤"
	L.NOTIFICATION_IS_NOW_ONLINE = "ë‹˜ì´ í˜„ìž¬ ì˜¨ë¼ì¸ìž…ë‹ˆë‹¤"
	...
	L.NOTIFICATION_TEST_COMPLETE = "í…ŒìŠ¤íŠ¸ ì™„ë£Œ!"
	...
	L.SETTINGS_TAB_NOTIFICATIONS = "ì•Œë¦¼"
	...
	-- Quiet Hours & Filters
	L.SETTINGS_NOTIFY_QUIET_HEADER = "ì¡°ìš©í•œ ì‹œê°„"
	...
	L.SETTINGS_NOTIFY_OFFLINE_HEADER = "ì˜¤í”„ë¼ì¸ ì•Œë¦¼"
	...
	L.CORE_LOADED = "|cff00ff00ë¡œë“œë¨|r"
	...
	L.SETTINGS_NOTIFY_TITLE = "ì•Œë¦¼"
	L.SETTINGS_NOTIFY_DESC = "ìŠ¤ë§ˆíŠ¸ ì¹œêµ¬ ì•Œë¦¼ì„ ì„¤ì •í•©ë‹ˆë‹¤."
	L.SETTINGS_NOTIFY_DISPLAY_HEADER = "í‘œì‹œ"
	L.SETTINGS_NOTIFY_DISPLAY_MODE = "ëª¨ë“œ:"
	L.SETTINGS_NOTIFY_MODE_TOAST = "í† ìŠ¤íŠ¸ (íŒì—…)"
	L.SETTINGS_NOTIFY_MODE_CHAT = "ì±„íŒ… ë©”ì‹œì§€"
	L.SETTINGS_NOTIFY_MODE_DISABLED = "ë¹„í™œì„±í™”"
	L.SETTINGS_NOTIFY_MODE_NONE = "ë¹„í™œì„±í™”"
	L.SETTINGS_NOTIFY_MODE_BOTH = "ëª¨ë‘"
	L.SETTINGS_NOTIFY_TEST = "í…ŒìŠ¤íŠ¸ ì•Œë¦¼"
	L.SETTINGS_NOTIFY_MODE_DESC = "|cffffcc00í† ìŠ¤íŠ¸:|r ê°„íŽ¸í•œ íŒì—…\n|cffffcc00ì±„íŒ… ë©”ì‹œì§€:|r ì±„íŒ…ì°½ í…ìŠ¤íŠ¸\n|cffffcc00ë¹„í™œì„±í™”:|r ì•Œë¦¼ ì—†ìŒ"
