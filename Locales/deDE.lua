...
BFL:RegisterLocale("deDE", function()
	...
	L.SETTINGS_THEME_ARTWORK_VISIBILITY = "Blizzard-Artwork-Sichtbarkeit"
	L.SETTINGS_THEME_ARTWORK_VISIBILITY_DESC = "Steuert, wie viel originales Blizzard-Artwork unter dem Skin sichtbar bleibt."
