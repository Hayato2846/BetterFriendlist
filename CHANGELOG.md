...
### Improved
- **Appearance Onboarding** - Reworked the dialog around the portraitless Blizzard shell used by Legacy Settings, with a dedicated inset, separated step header, Modern SocialUI card surfaces, modern buttons and checkboxes, accurate Modern/Legacy previews, Simple and Compact Mode setup, theme-specific skins, a scrollbar-free theme grid, and a complete localization contract for every theme.
