...
### Improved
- **EllesmereUI Visual Parity** - The Modern friendlist now uses EUI's translucent shell, accent-colored BFL icons, clean top controls and footer actions, while preserving Blizzard's side tabs, group headers, invite buttons, font geometry, and transparent Battle.net bar.
